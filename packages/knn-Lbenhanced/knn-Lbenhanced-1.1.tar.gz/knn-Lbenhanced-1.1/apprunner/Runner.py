...
# Load data
train_file = FileReader.load_data("/Users/morad/Desktop/TSdatasets/ItalyPowerDemand/ItalyPowerDemand_TRAIN.arff")
test_file = FileReader.load_data("/Users/morad/Desktop/TSdatasets/ItalyPowerDemand/ItalyPowerDemand_TEST.arff")
...
m = KnnLb.KnnLb(n_neighbors=1, max_warping_window=10, window=5, V=2.4)
m.fit(train_data, train_labels, train_cache, test_cache)
start = timeit.default_timer()
label = m.predict(test_data[4])
