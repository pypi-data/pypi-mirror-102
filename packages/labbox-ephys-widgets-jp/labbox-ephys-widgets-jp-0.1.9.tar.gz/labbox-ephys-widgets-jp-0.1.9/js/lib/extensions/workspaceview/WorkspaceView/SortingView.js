...
const SortingView = (props) => {
    ...
    const emptySortingInfo = useMemo(() => ({
        unit_ids: [],
        samplerate: 0
    }), []);
    ...
    return (React.createElement("div", null,
        React.createElement("div", { style: contentWrapperStyle },
            React.createElement(sv.component, Object.assign({}, svProps, { sorting: sorting || emptySorting, recording: recording, sortingInfo: sortingInfo || emptySortingInfo, recordingInfo: recordingInfo, selection: selection, selectionDispatch: selectionDispatch, curation: curation, curationDispatch: curationDispatch, readOnly: readOnly, calculationPool: calculationPool, width: contentWidth, height: contentHeight }))),
        React.createElement("div", { style: footerStyle }, sorting ? (React.createElement("span", null,
            `Sorting: `,
            sorting.sortingLabel,
            ` | Recording: `,
            React.createElement(Hyperlink, { onClick: handleGotoRecording }, recording.recordingLabel))) : (React.createElement("span", null,
            `Recording: `,
