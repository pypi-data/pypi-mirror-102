...
const WorkspaceViewWrapper = ({ workspaceUri, onWorkspaceRouteChanged }) => {
    ...
    return (React.createElement(MuiThemeProvider, { theme: theme },
        React.createElement("div", { ref: divRef, className: "WorkspaceViewWrapper", style: { position: 'absolute', left: 0, right: 0, top: 0, bottom: 0 } },
            React.createElement(MainWindow, { workspace: workspace, workspaceDispatch: workspaceDispatch, workspaceRoute: workspaceRoute, workspaceRouteDispatch: workspaceRouteDispatch, version: version, width: width || 700, height: height || 700 }))));
};
