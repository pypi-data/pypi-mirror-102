...
class MeSHOptions(KnowledgeParserOptions):
    ...
    """
    branches : str = Query(None, description="Comma-separated list of branches to import, for example 'B,C' to import only descriptors belonging to the Organisms & Diseases categories")
