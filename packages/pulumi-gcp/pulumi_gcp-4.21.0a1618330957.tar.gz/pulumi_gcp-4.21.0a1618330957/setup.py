...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '4.21.0-alpha.1618330957+b6f0d5fa'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 4.21.0-alpha.1618330957+b6f0d5fa`
                """)
            else:
                raise
