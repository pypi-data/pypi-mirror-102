...
def initial_solution_random_fit(current_schedule, ts, MAS_allowed, day_of_week_indexes, OT_indexes):
	"""
	To fit a list of surgeries into a timetable randomly
	:param current_schedule: (ndarray) a current solution
	:param ts: (list) list of surgeries to schedule
	...
	:return: (ndarray) a new solution with surgeries slotted in randomly
	"""
