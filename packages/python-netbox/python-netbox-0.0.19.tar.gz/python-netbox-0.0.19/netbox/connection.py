    ...
    def get(self, param, key=None, limit=0, **kwargs):
        ...
        if kwargs:
            ...
            if '_choices' in param:
                url = '{}{}{}/?limit={}'.format(self.base_url, urllib.parse.quote(param), key, limit)
            else:
                url = '{}{}/?q={}&limit={}'.format(self.base_url, urllib.parse.quote(param), key, limit)
        else:
            url = '{}{}?limit={}'.format(self.base_url, urllib.parse.quote(param), limit)
