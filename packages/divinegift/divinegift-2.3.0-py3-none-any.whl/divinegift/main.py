...
def create_json(json_data: Union[str, list, dict], json_fname: str = None, encoding: str = 'utf-8'):
    if not json_fname:
...
def create_yaml(yaml_data: Union[str, list, dict], yaml_fname: str = None, encoding: str = 'utf-8'):
    if not yaml_fname:
...
class BaseMl:
    ...
    def set_data(self, data: Union[str, list, dict]):
        self.data = data
