...
list_column_id = _py_interop_table.list_column_id

def parse_column_id(name):
    return _py_interop_table.parse_column_id(name)
parse_column_id = _py_interop_table.parse_column_id

def to_string_column_id(value):
    return _py_interop_table.to_string_column_id(value)
to_string_column_id = _py_interop_table.to_string_column_id
