...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'hcloud', '1.0.0-alpha.1618490186+1a30dbfa'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource hcloud 1.0.0-alpha.1618490186+1a30dbfa`
                """)
            else:
                raise
