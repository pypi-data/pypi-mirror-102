...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'splunk', '1.0.0-alpha.1618657588+9a61bbc9'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource splunk 1.0.0-alpha.1618657588+9a61bbc9`
                """)
            else:
                raise
