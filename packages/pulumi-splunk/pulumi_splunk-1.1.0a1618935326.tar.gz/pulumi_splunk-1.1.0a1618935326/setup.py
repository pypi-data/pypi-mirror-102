...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'splunk', '1.1.0-alpha.1618935326+b1bbedf2'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource splunk 1.1.0-alpha.1618935326+b1bbedf2`
                """)
            else:
                raise
