...
\033[1mVerificação Parte 4\033[0m: {calculo_verificacao} <= 1
    ...
    '''
            ...
            return f'''\033[1mExcentricidade acidental (ea)\033[0m: {self.excentricidade[4][0]} mm
\033[1mEc0m\033[0m: {self.Ec0m} MPa
\033[1mMódulo de Elasticidade (Ec0ef)\033[0m: {self.modulo_elasticidade} MPa
...
\033[1mVerificação Parte 4 em Z\033[0m: {round(calculo_verificacao_z)} <= 1
...
\033[1mVerificação Parte 4 em Y\033[0m: {round(calculo_verificacao_y)} <= 1
...
\033[1mVerificação Parte 3.1\033[0m: {round(self.verificacao_parte_1()[1], 3)} < 1
        \033[1m{self.verificacao_parte_1()[0]}\033[0m

\033[1mVerificação Parte 3.2\033[0m: {round(self.verificacao_parte_2()[1], 3)} < 1
