...
class PilarDeMadeira:
    ...
    def verificacao_parte_3(self):
        if type(self.excentricidade) == type(None):
            ...
            calculo_verificacao = ((self.flexao_composta/self.fc0d) +
            ...
            return f'''Excentricidade acidental (ea): {self.excentricidade[4][0]} mm
{z_ou_y[self.excentricidade[3]][0]}: {self.excentricidade[4][1]} mm
{z_ou_y[self.excentricidade[3]][1]}: {self.excentricidade[4][2]} mm
Ec0m: {self.Ec0m} MPa
Módulo de Elasticidade (Ec0ef): {self.modulo_elasticidade} MPa
Fe: {self.excentricidade[2]} kN
{z_ou_y[self.excentricidade[3]][5]}: {self.excentricidade[4][-1]} mm
Novo Momento Fletor em {z_ou_y[self.excentricidade[3]][-1]} ({z_ou_y[self.excentricidade[3]][2]}): {self.excentricidade[1]}
Nova Tensão Momento Fletor em {z_ou_y[self.excentricidade[3]][-1]} ({z_ou_y[self.excentricidade[3]][3]}): {self.excentricidade[0]}

Verificação Parte 4: {calculo_verificacao} <= 1
        {verificacao}
    '''

        elif type(self.excentricidade) == type(list()):

            calculo_verificacao_z = ((self.flexao_composta/self.fc0d) +
            ...
            calculo_verificacao_y = ((self.flexao_composta/self.fc0d) +
...
Verificação em Z:
eiy: {self.excentricidade[0][4][1]} mm
e1y: {self.excentricidade[0][4][2]} mm
Fe: {self.excentricidade[0][2]} kN
eyd: {self.excentricidade[0][4][-1]} mm
Novo Momento Fletor em Z (Mzd): {self.excentricidade[0][1]}
Nova Tensão Momento Fletor em Z (σMzd): {self.excentricidade[0][0]}

Verificação Parte 4 em Z: {calculo_verificacao_z} <= 1
        {verificacao_z}

Verificação em Y:
eiz: {self.excentricidade[1][4][1]} mm
e1z: {self.excentricidade[1][4][2]} mm
Fe: {self.excentricidade[1][2]} kN
ezd: {self.excentricidade[1][4][-1]} mm
Novo Momento Fletor em Y (Myd): {self.excentricidade[1][1]}
Nova Tensão Momento Fletor em Y (σMyd): {self.excentricidade[1][0]}

Verificação Parte 4 em T: {calculo_verificacao_y} <= 1
        {verificacao_y}
    '''
