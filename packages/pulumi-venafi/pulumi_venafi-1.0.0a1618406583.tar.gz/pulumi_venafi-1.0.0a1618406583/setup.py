...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'venafi', '1.0.0-alpha.1618406583+d109b668'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource venafi 1.0.0-alpha.1618406583+d109b668`
                """)
            else:
                raise
