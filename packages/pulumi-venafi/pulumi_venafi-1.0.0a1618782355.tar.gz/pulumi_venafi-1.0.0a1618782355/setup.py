...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'venafi', '1.0.0-alpha.1618782355+a5777076'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource venafi 1.0.0-alpha.1618782355+a5777076`
                """)
            else:
                raise
