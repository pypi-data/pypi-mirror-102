...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'venafi', '1.1.0-alpha.1618935168+fdd7ab47'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource venafi 1.1.0-alpha.1618935168+fdd7ab47`
                """)
            else:
                raise
