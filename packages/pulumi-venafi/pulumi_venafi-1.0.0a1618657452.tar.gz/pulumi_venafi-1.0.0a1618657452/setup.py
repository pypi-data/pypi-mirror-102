...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'venafi', '1.0.0-alpha.1618657452+0fdd144b'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource venafi 1.0.0-alpha.1618657452+0fdd144b`
                """)
            else:
                raise
