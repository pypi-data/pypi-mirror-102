...
def AFM(linear_feature_columns, dnn_feature_columns, fm_group=DEFAULT_GROUP_NAME, use_attention=True,
    ...
    features = build_input_features(
        linear_feature_columns + dnn_feature_columns) # Input layer 설정(OrderedDict type), linear_feature_columns, dnn_feature_columns: 피쳐에 대한 이름, voca size, embedding size 정보가 담긴 리스트
