...
class DatabricksBundle(Bundle):
    ...
    def autodetect():
        if is_databricks():
            from databricksbundle.bootstrap import package_config_reader  # noqa: F401

            DaipeCore.config_reader = package_config_reader.read
    ...
    def modify_services(self, services: List[Service], aliases: List[ServiceAlias], parameters: Box):
        ...
        aliases.append(ServiceAlias("daipecore.logger", "databricksbundle.logger"))
