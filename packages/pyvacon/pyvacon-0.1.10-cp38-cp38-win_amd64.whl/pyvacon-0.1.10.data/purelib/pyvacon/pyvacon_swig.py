...
def getEnumClass(clsName, name):
    r"""getEnumClass(std::string const & clsName, std::string const & name) -> std::pair< PyObject *,PyObject * >"""
    return _pyvacon_swig.getEnumClass(clsName, name)
...
class EuropeanVanillaSpecification(BaseSpecification):
    ...
    def convertIntoBarrierSpecification(self, *args):
        r"""convertIntoBarrierSpecification(EuropeanVanillaSpecification self, std::shared_ptr< DividendTable const > const & div=std::shared_ptr< DividendTable const >()) -> std::shared_ptr< BarrierSpecification const >"""
        return _pyvacon_swig.EuropeanVanillaSpecification_convertIntoBarrierSpecification(self, *args)
...
class DiscountCurveTimeShiftStickyness(object):
    r"""Proxy of C++ DiscountCurveTimeShiftStickyness class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    _Type_NONE = _pyvacon_swig.DiscountCurveTimeShiftStickyness__Type_NONE
    
    _Type_StickyTimeToMaturity = _pyvacon_swig.DiscountCurveTimeShiftStickyness__Type_StickyTimeToMaturity
    
    _Type_StickyFwdConsistent = _pyvacon_swig.DiscountCurveTimeShiftStickyness__Type_StickyFwdConsistent
    

    Type = _enum_creator.create_enum('Type', vars())
    _Type_Str = (lambda t: lambda x : t[x])(Type)
    setEnumClass('DiscountCurveTimeShiftStickyness', 'Type', Type, _Type_Str)


    def __init__(self, type):
        r"""__init__(DiscountCurveTimeShiftStickyness self, DiscountCurveTimeShiftStickyness::Type type) -> DiscountCurveTimeShiftStickyness"""
        _pyvacon_swig.DiscountCurveTimeShiftStickyness_swiginit(self, _pyvacon_swig.new_DiscountCurveTimeShiftStickyness(type))

    def getType(self):
        r"""getType(DiscountCurveTimeShiftStickyness self) -> DiscountCurveTimeShiftStickyness::Type"""
        return _pyvacon_swig.DiscountCurveTimeShiftStickyness_getType(self)
    __swig_destroy__ = _pyvacon_swig.delete_DiscountCurveTimeShiftStickyness

# Register DiscountCurveTimeShiftStickyness in _pyvacon_swig:
_pyvacon_swig.DiscountCurveTimeShiftStickyness_swigregister(DiscountCurveTimeShiftStickyness)

class VolatilitySurfaceTimeShiftStickyness(object):
    r"""Proxy of C++ VolatilitySurfaceTimeShiftStickyness class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    _Type_NONE = _pyvacon_swig.VolatilitySurfaceTimeShiftStickyness__Type_NONE
    
    _Type_StickyTimeToMaturity = _pyvacon_swig.VolatilitySurfaceTimeShiftStickyness__Type_StickyTimeToMaturity
    
    _Type_StickyExpiry = _pyvacon_swig.VolatilitySurfaceTimeShiftStickyness__Type_StickyExpiry
    

    Type = _enum_creator.create_enum('Type', vars())
    _Type_Str = (lambda t: lambda x : t[x])(Type)
    setEnumClass('VolatilitySurfaceTimeShiftStickyness', 'Type', Type, _Type_Str)


    def __init__(self, type):
        r"""__init__(VolatilitySurfaceTimeShiftStickyness self, VolatilitySurfaceTimeShiftStickyness::Type type) -> VolatilitySurfaceTimeShiftStickyness"""
        _pyvacon_swig.VolatilitySurfaceTimeShiftStickyness_swiginit(self, _pyvacon_swig.new_VolatilitySurfaceTimeShiftStickyness(type))

    def getType(self):
        r"""getType(VolatilitySurfaceTimeShiftStickyness self) -> VolatilitySurfaceTimeShiftStickyness::Type"""
        return _pyvacon_swig.VolatilitySurfaceTimeShiftStickyness_getType(self)
    __swig_destroy__ = _pyvacon_swig.delete_VolatilitySurfaceTimeShiftStickyness

# Register VolatilitySurfaceTimeShiftStickyness in _pyvacon_swig:
_pyvacon_swig.VolatilitySurfaceTimeShiftStickyness_swigregister(VolatilitySurfaceTimeShiftStickyness)

class VolatilitySurfaceFwdStickyness(object):
    r"""Proxy of C++ VolatilitySurfaceFwdStickyness class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    _Type_NONE = _pyvacon_swig.VolatilitySurfaceFwdStickyness__Type_NONE
    
    _Type_StickyStrike = _pyvacon_swig.VolatilitySurfaceFwdStickyness__Type_StickyStrike
    
    _Type_StickyFwdMoneyness = _pyvacon_swig.VolatilitySurfaceFwdStickyness__Type_StickyFwdMoneyness
    
    _Type_StickyXStrike = _pyvacon_swig.VolatilitySurfaceFwdStickyness__Type_StickyXStrike
    

    Type = _enum_creator.create_enum('Type', vars())
    _Type_Str = (lambda t: lambda x : t[x])(Type)
    setEnumClass('VolatilitySurfaceFwdStickyness', 'Type', Type, _Type_Str)


    def __init__(self, type):
        r"""__init__(VolatilitySurfaceFwdStickyness self, VolatilitySurfaceFwdStickyness::Type type) -> VolatilitySurfaceFwdStickyness"""
        _pyvacon_swig.VolatilitySurfaceFwdStickyness_swiginit(self, _pyvacon_swig.new_VolatilitySurfaceFwdStickyness(type))

    def getType(self):
        r"""getType(VolatilitySurfaceFwdStickyness self) -> VolatilitySurfaceFwdStickyness::Type"""
        return _pyvacon_swig.VolatilitySurfaceFwdStickyness_getType(self)
    __swig_destroy__ = _pyvacon_swig.delete_VolatilitySurfaceFwdStickyness

# Register VolatilitySurfaceFwdStickyness in _pyvacon_swig:
_pyvacon_swig.VolatilitySurfaceFwdStickyness_swigregister(VolatilitySurfaceFwdStickyness)

class CorrelationStickyType(object):
    r"""Proxy of C++ CorrelationStickyType class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    _Type_NONE = _pyvacon_swig.CorrelationStickyType__Type_NONE
    
    _Type_STICKY_CORRELATIONS = _pyvacon_swig.CorrelationStickyType__Type_STICKY_CORRELATIONS
    
    _Type_STICKY_CORRELATION_MODEL = _pyvacon_swig.CorrelationStickyType__Type_STICKY_CORRELATION_MODEL
    
    _Type_SHIFTED_CORRELATION_MODEL = _pyvacon_swig.CorrelationStickyType__Type_SHIFTED_CORRELATION_MODEL
    

    Type = _enum_creator.create_enum('Type', vars())
    _Type_Str = (lambda t: lambda x : t[x])(Type)
    setEnumClass('CorrelationStickyType', 'Type', Type, _Type_Str)


    def __init__(self, type):
        r"""__init__(CorrelationStickyType self, CorrelationStickyType::Type type) -> CorrelationStickyType"""
        _pyvacon_swig.CorrelationStickyType_swiginit(self, _pyvacon_swig.new_CorrelationStickyType(type))

    def getType(self):
        r"""getType(CorrelationStickyType self) -> CorrelationStickyType::Type"""
        return _pyvacon_swig.CorrelationStickyType_getType(self)
    __swig_destroy__ = _pyvacon_swig.delete_CorrelationStickyType

# Register CorrelationStickyType in _pyvacon_swig:
_pyvacon_swig.CorrelationStickyType_swigregister(CorrelationStickyType)

class GlobalSettings(object):
    r"""Proxy of C++ GlobalSettings class."""
    ...
    @staticmethod
    def setDiscountCurveTimeShiftStickyness(type):
        r"""setDiscountCurveTimeShiftStickyness(DiscountCurveTimeShiftStickyness::Type type)"""
        return _pyvacon_swig.GlobalSettings_setDiscountCurveTimeShiftStickyness(type)

    @staticmethod
    def getDiscountCurveTimeShiftStickyness():
        r"""getDiscountCurveTimeShiftStickyness() -> DiscountCurveTimeShiftStickyness::Type"""
        return _pyvacon_swig.GlobalSettings_getDiscountCurveTimeShiftStickyness()

    @staticmethod
    def setVolatilitySurfaceTimeShiftStickyness(type):
        r"""setVolatilitySurfaceTimeShiftStickyness(VolatilitySurfaceTimeShiftStickyness::Type type)"""
        return _pyvacon_swig.GlobalSettings_setVolatilitySurfaceTimeShiftStickyness(type)

    @staticmethod
    def getVolatilitySurfaceTimeShiftStickyness():
        r"""getVolatilitySurfaceTimeShiftStickyness() -> VolatilitySurfaceTimeShiftStickyness::Type"""
        return _pyvacon_swig.GlobalSettings_getVolatilitySurfaceTimeShiftStickyness()

    @staticmethod
    def setVolatilitySurfaceFwdStickyness(type):
        r"""setVolatilitySurfaceFwdStickyness(VolatilitySurfaceFwdStickyness::Type type)"""
        return _pyvacon_swig.GlobalSettings_setVolatilitySurfaceFwdStickyness(type)

    @staticmethod
    def getVolatilitySurfaceFwdStickyness():
        r"""getVolatilitySurfaceFwdStickyness() -> VolatilitySurfaceFwdStickyness::Type"""
        return _pyvacon_swig.GlobalSettings_getVolatilitySurfaceFwdStickyness()

    @staticmethod
    def setCorrelationStickyType(type):
        r"""setCorrelationStickyType(CorrelationStickyType::Type type)"""
        return _pyvacon_swig.GlobalSettings_setCorrelationStickyType(type)

    @staticmethod
    def getCorrelationStickyType():
        r"""getCorrelationStickyType() -> CorrelationStickyType::Type"""
        return _pyvacon_swig.GlobalSettings_getCorrelationStickyType()
    __swig_destroy__ = _pyvacon_swig.delete_GlobalSettings

# Register GlobalSettings in _pyvacon_swig:
_pyvacon_swig.GlobalSettings_swigregister(GlobalSettings)

def GlobalSettings_setDiscountCurveTimeShiftStickyness(type):
    r"""GlobalSettings_setDiscountCurveTimeShiftStickyness(DiscountCurveTimeShiftStickyness::Type type)"""
    return _pyvacon_swig.GlobalSettings_setDiscountCurveTimeShiftStickyness(type)

def GlobalSettings_getDiscountCurveTimeShiftStickyness():
    r"""GlobalSettings_getDiscountCurveTimeShiftStickyness() -> DiscountCurveTimeShiftStickyness::Type"""
    return _pyvacon_swig.GlobalSettings_getDiscountCurveTimeShiftStickyness()

def GlobalSettings_setVolatilitySurfaceTimeShiftStickyness(type):
    r"""GlobalSettings_setVolatilitySurfaceTimeShiftStickyness(VolatilitySurfaceTimeShiftStickyness::Type type)"""
    return _pyvacon_swig.GlobalSettings_setVolatilitySurfaceTimeShiftStickyness(type)

def GlobalSettings_getVolatilitySurfaceTimeShiftStickyness():
    r"""GlobalSettings_getVolatilitySurfaceTimeShiftStickyness() -> VolatilitySurfaceTimeShiftStickyness::Type"""
    return _pyvacon_swig.GlobalSettings_getVolatilitySurfaceTimeShiftStickyness()

def GlobalSettings_setVolatilitySurfaceFwdStickyness(type):
    r"""GlobalSettings_setVolatilitySurfaceFwdStickyness(VolatilitySurfaceFwdStickyness::Type type)"""
    return _pyvacon_swig.GlobalSettings_setVolatilitySurfaceFwdStickyness(type)

def GlobalSettings_getVolatilitySurfaceFwdStickyness():
    r"""GlobalSettings_getVolatilitySurfaceFwdStickyness() -> VolatilitySurfaceFwdStickyness::Type"""
    return _pyvacon_swig.GlobalSettings_getVolatilitySurfaceFwdStickyness()

def GlobalSettings_setCorrelationStickyType(type):
    r"""GlobalSettings_setCorrelationStickyType(CorrelationStickyType::Type type)"""
    return _pyvacon_swig.GlobalSettings_setCorrelationStickyType(type)

def GlobalSettings_getCorrelationStickyType():
    r"""GlobalSettings_getCorrelationStickyType() -> CorrelationStickyType::Type"""
    return _pyvacon_swig.GlobalSettings_getCorrelationStickyType()
