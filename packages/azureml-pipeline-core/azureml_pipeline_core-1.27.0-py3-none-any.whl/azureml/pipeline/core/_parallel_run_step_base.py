...
from azureml.data.output_dataset_config import OutputTabularDatasetConfig, OutputFileDatasetConfig, \
    OutputDatasetConfig, LinkFileOutputDatasetConfig, LinkTabularOutputDatasetConfig
...
class _ParallelRunStepBase(_PythonScriptStepBase):
    ...
    def _get_input_type(self, in_ds):
        ...
        if input_type == DatasetConsumptionConfig:
            ...
            if (
                isinstance(real_ds_obj, TabularDataset) or isinstance(real_ds_obj, OutputTabularDatasetConfig) or
                isinstance(real_ds_obj, LinkTabularOutputDatasetConfig)
