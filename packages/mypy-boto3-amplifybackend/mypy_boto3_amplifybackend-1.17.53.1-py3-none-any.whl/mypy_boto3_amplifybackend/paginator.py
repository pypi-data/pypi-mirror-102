...
class ListBackendJobsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListBackendJobs.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.53/reference/services/amplifybackend.html#AmplifyBackend.Paginator.ListBackendJobs.paginate)
        """
