from databricksbundle.notebook.lineage.argument.ArgumentMappingInterface import ArgumentMappingInterface
from datalakebundle.notebook.lineage.argument.ReadCsv import ReadCsv
