"""This module contains the :class:`.RunGovernor`. """
import uuid
from typing import TYPE_CHECKING, Dict

from palaestrai.experiment import LOG
...
if TYPE_CHECKING:
    ...
    from palaestrai.experiment import Experiment, TerminationCondition
...
class RunGovernor:
    ...
    handles a single experiment by starting it, initialize the
    simulation controllers, the environment and the agent conductors,
    and, finally, shutting the experiment down.
    ...
    experiment_run_id: str
        The UUID of the current experiment.
    ...
    def __init__(self, broker_uri: str, uid: str = None):
        # self._binding_uri = "tcp://*:45306"
        self.uid = uid if uid else "RunGovernor-%s" % str(uuid.uuid4())
        self.broker_uri = broker_uri
        self.major_domo_client = None
        self.major_domo_worker = None
        ...
        # "Workaround" to satisfy the type checking ...
