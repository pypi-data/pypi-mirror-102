...
[boto3.CloudSearchDomain 1.17.54](https://boto3.amazonaws.com/v1/documentation/api/1.17.54/reference/services/cloudsearchdomain.html#CloudSearchDomain) service
compatible with
