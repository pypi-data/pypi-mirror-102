...
def is_ramp(signal, slope, tol, during=None, strictness=1, time_tol=0, initial_value=None):
    ...
    time_tol: float or timedelta
        Time tolerance - argument which allows that signal is leading or lagging up to specified time in seconds,
        compared to created reference.
    initial_value: if specified, reference ramp is created starting with this value. Otherwise, initial value of the
    ...
    """
    return _impl.is_ramp(signal, slope, tol, during, strictness, time_tol, initial_value)
...
def assert_is_ramp(signal, slope, tol, during=None, strictness=1, time_tol=0, initial_value=None):
    ...
    """
    return _impl.assert_is_ramp(signal, slope, tol, during, strictness, time_tol, initial_value)
