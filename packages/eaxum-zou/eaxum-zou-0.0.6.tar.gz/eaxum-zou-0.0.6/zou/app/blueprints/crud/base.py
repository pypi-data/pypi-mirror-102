...
from zou.app.services import genesis_service
    ...
    def post(self):
        ...
        try:
            ...
            if self.model.__tablename__ == 'project':
                genesis_service.create_project(data=data)
...
class BaseModelResource(Resource):
    ...
    def put(self, instance_id):
        ...
        try:
            ...
            if self.model.__tablename__ == 'project':
                genesis_service.project_rename(data=data,instance_dict=instance_dict)
