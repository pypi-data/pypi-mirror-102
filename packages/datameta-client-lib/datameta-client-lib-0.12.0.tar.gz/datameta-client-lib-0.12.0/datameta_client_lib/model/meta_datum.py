...
class MetaDatum(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, regex_description, long_description, example, reg_exp, date_time_fmt, is_mandatory, order, is_file, is_submission_unique, is_site_unique, *args, **kwargs):  # noqa: E501
