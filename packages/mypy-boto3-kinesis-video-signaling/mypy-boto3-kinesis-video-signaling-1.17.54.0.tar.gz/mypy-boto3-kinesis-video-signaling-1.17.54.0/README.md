...
[boto3.KinesisVideoSignalingChannels 1.17.54](https://boto3.amazonaws.com/v1/documentation/api/1.17.54/reference/services/kinesis-video-signaling.html#KinesisVideoSignalingChannels) service
compatible with
