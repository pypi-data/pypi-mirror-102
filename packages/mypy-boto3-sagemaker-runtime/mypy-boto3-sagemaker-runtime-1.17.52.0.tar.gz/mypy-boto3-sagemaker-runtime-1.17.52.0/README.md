...
[boto3.SageMakerRuntime 1.17.52](https://boto3.amazonaws.com/v1/documentation/api/1.17.52/reference/services/sagemaker-runtime.html#SageMakerRuntime) service
compatible with
