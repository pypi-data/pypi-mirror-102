...
_GETCLIENTCONFIGRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='client_config_str_list', full_name='baidu.paddle_serving.multi_lang.GetClientConfigResponse.client_config_str_list', index=0,
