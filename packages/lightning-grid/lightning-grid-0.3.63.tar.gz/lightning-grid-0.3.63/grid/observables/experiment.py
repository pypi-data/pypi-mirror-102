...
class Experiment(BaseObservable):
    ...
    def render_experiments(experiments) -> Table:
        ...
        for experiment in experiments:
            ...
            duration_str = get_experiment_duration_string(created_at=experiment['createdAt'],
    ...
    def follow(self):
        ...
        if not dependencies:
            raise click.ClickException("Run doesn't have dependencies. Nothing to follow.")
        ...
        try:
            ...
            for log in stream:
                ...
                message = log['getTaskMessage']['message'].rstrip()
