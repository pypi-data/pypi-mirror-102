...
class TestCancel:
    ...
    def test_logs_fails_with_ex(self, monkeypatch):
        ...
        monkeypatch.setattr(resolvers, 'get_archive_experiment_logs', get_archive_experiment_logs)
    ...
    def test_logs_for_deleted_exp_fails(self, monkeypatch):
        ...
        monkeypatch.setattr(resolvers, 'get_experiment_details', get_experiment_details)
