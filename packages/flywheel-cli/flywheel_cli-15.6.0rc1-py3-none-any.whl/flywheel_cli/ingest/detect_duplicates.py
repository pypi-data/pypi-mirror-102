...
def detect_uid_conflicts_in_item(item, uids, insert_errors, errors_to_hide) -> bool:
    """
    ...
    for uid in uids:
        ...
        if uid.study_instance_uid != study_instance_uid and (
            errors.DifferentStudyInstanceUID.code not in errors_to_hide
        ):
        ...
        if uid.series_instance_uid != series_instance_uid and (
            errors.DifferentSeriesInstanceUID.code not in errors_to_hide
        ):
