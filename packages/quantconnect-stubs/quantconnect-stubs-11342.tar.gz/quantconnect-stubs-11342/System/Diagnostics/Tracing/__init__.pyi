...
class EventSource(System.Object, System.IDisposable):
    ...
    @property
    def EventCommandExecuted(self) -> typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]:
        """Fires when a Command (e.g. Enable) comes from a an EventListener."""
        ...

    @EventCommandExecuted.setter
    def EventCommandExecuted(self, value: typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]):
        """Fires when a Command (e.g. Enable) comes from a an EventListener."""
        ...
...
class EventListener(System.Object, System.IDisposable):
    ...
    @property
    def EventSourceCreated(self) -> typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]:
        """
    ...
    def EventSourceCreated(self, value: typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]):
        """
        This event is raised whenever a new eventSource is 'attached' to the dispatcher.
        This can happen for all existing EventSources when the EventListener is created
        as well as for any EventSources that come into existence after the EventListener
    ...
    @property
    def EventWritten(self) -> typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]:
        """
    ...
    @EventWritten.setter
    def EventWritten(self, value: typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]):
        """
        This event is raised whenever an event has been written by a EventSource for which
        the EventListener has enabled events.
        """
