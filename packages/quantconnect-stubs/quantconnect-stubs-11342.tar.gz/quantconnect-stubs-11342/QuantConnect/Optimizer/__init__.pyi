...
class LeanOptimizer(System.Object, System.IDisposable, metaclass=abc.ABCMeta):
    ...
    @property
    def Ended(self) -> typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]:
        """Event triggered when the optimization work ended"""
        ...

    @Ended.setter
    def Ended(self, value: typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]):
        """Event triggered when the optimization work ended"""
        ...
