...
class Brokerage(System.Object, QuantConnect.Interfaces.IBrokerage, metaclass=abc.ABCMeta):
    ...
    @property
    def OrderStatusChanged(self) -> typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]:
        """Event that fires each time an order is filled"""
        ...

    @OrderStatusChanged.setter
    def OrderStatusChanged(self, value: typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]):
        """Event that fires each time an order is filled"""
        ...

    @property
    def OptionPositionAssigned(self) -> typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]:
        """Event that fires each time a short option position is assigned"""
        ...

    @OptionPositionAssigned.setter
    def OptionPositionAssigned(self, value: typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]):
        """Event that fires each time a short option position is assigned"""
        ...

    @property
    def AccountChanged(self) -> typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]:
        """Event that fires each time a user's brokerage account is changed"""
        ...

    @AccountChanged.setter
    def AccountChanged(self, value: typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]):
        """Event that fires each time a user's brokerage account is changed"""
        ...

    @property
    def Message(self) -> typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]:
        """Event that fires when an error is encountered in the brokerage"""
        ...

    @Message.setter
    def Message(self, value: typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]):
        """Event that fires when an error is encountered in the brokerage"""
        ...
...
class IWebSocket(metaclass=abc.ABCMeta):
    ...
    @property
    @abc.abstractmethod
    def Open(self) -> typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]:
        """On Open event"""
        ...

    @Open.setter
    @abc.abstractmethod
    def Open(self, value: typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]):
        """On Open event"""
        ...

    @property
    @abc.abstractmethod
    def Closed(self) -> typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]:
        """On Close event"""
        ...

    @Closed.setter
    @abc.abstractmethod
    def Closed(self, value: typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]):
        """On Close event"""
        ...
...
class IOrderBookUpdater(typing.Generic[QuantConnect_Brokerages_IOrderBookUpdater_K, QuantConnect_Brokerages_IOrderBookUpdater_V], metaclass=abc.ABCMeta):
    ...
    @property
    @abc.abstractmethod
    def BestBidAskUpdated(self) -> typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]:
        """Event fired each time BestBidPrice or BestAskPrice are changed"""
        ...

    @BestBidAskUpdated.setter
    @abc.abstractmethod
    def BestBidAskUpdated(self, value: typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]):
        """Event fired each time BestBidPrice or BestAskPrice are changed"""
        ...
...
class IConnectionHandler(System.IDisposable, metaclass=abc.ABCMeta):
    ...
    @property
    @abc.abstractmethod
    def ConnectionLost(self) -> typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]:
        """Event that fires when a connection loss is detected"""
        ...

    @ConnectionLost.setter
    @abc.abstractmethod
    def ConnectionLost(self, value: typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]):
        """Event that fires when a connection loss is detected"""
        ...

    @property
    @abc.abstractmethod
    def ConnectionRestored(self) -> typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]:
        """Event that fires when a lost connection is restored"""
        ...

    @ConnectionRestored.setter
    @abc.abstractmethod
    def ConnectionRestored(self, value: typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]):
        """Event that fires when a lost connection is restored"""
        ...

    @property
    @abc.abstractmethod
    def ReconnectRequested(self) -> typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]:
        """Event that fires when a reconnection attempt is required"""
        ...

    @ReconnectRequested.setter
    @abc.abstractmethod
    def ReconnectRequested(self, value: typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]):
        """Event that fires when a reconnection attempt is required"""
        ...
