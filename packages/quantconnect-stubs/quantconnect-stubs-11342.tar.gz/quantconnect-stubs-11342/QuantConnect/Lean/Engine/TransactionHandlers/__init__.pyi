...
class BrokerageTransactionHandler(System.Object, QuantConnect.Lean.Engine.TransactionHandlers.ITransactionHandler):
    ...
    @property
    def NewOrderEvent(self) -> typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]:
        """Event fired when there is a new OrderEvent"""
        ...

    @NewOrderEvent.setter
    def NewOrderEvent(self, value: typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]):
        """Event fired when there is a new OrderEvent"""
        ...
