...
class IObjectStore(System.IDisposable, System.Collections.Generic.IEnumerable[System.Collections.Generic.KeyValuePair[str, typing.List[int]]], metaclass=abc.ABCMeta):
    ...
    @property
    @abc.abstractmethod
    def ErrorRaised(self) -> typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]:
        """Event raised each time there's an error"""
        ...

    @ErrorRaised.setter
    @abc.abstractmethod
    def ErrorRaised(self, value: typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]):
        """Event raised each time there's an error"""
        ...
