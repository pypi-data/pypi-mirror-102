...
class Universe(System.Object, System.IDisposable, metaclass=abc.ABCMeta):
    ...
    @property
    def SelectionChanged(self) -> typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]:
        """Event fired when the universe selection has changed"""
        ...

    @SelectionChanged.setter
    def SelectionChanged(self, value: typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]):
        """Event fired when the universe selection has changed"""
        ...
