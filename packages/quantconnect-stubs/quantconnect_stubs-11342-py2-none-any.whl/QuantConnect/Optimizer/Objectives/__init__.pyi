...
class Target(QuantConnect.Optimizer.Objectives.Objective):
    ...
    @property
    def Reached(self) -> typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]:
        """Fires when target complies specified value"""
        ...

    @Reached.setter
    def Reached(self, value: typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]):
        """Fires when target complies specified value"""
        ...
