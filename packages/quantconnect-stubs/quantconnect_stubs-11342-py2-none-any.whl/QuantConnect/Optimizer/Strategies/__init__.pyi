...
class IOptimizationStrategy(metaclass=abc.ABCMeta):
    ...
    @property
    @abc.abstractmethod
    def NewParameterSet(self) -> typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]:
        """Fires when new parameter set is retrieved"""
        ...

    @NewParameterSet.setter
    @abc.abstractmethod
    def NewParameterSet(self, value: typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]):
        """Fires when new parameter set is retrieved"""
        ...
