...
class Connection:
    conn_reuse_cache: Dict[Tuple[str, int], bool] = {}
    ...
    def __init__(
        ...
        # Quash a warning
        self.reuse_connection: Optional[bool] = None
        self.user_agent = user_agent
        self.set_reuse_flag(reuse)

    @staticmethod
    def flush_reuse_cache() -> None:
        Connection.conn_reuse_cache = {}

    def set_reuse_flag(self, reuse: Optional[bool]) -> None:
        self.reuse_connection = reuse

    def maybe_probe_reuse_flag(self) -> None:
