...
class SMWinservice(win32serviceutil.ServiceFramework):
    ...
    finish_query = """
        ...
        IF NOT EXISTS(SELECT 1 FROM (SELECT TOP(1) Id FROM EasyPostServices.dbo.{table} ORDER BY DateTime DESC) one WHERE  Type = '{status_type}' AND Description = '{status_description}')
        BEGIN
