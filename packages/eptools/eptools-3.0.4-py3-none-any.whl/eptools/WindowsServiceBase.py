...
class SMWinservice(win32serviceutil.ServiceFramework):
    ...
    _svc_name_ = self.get_default_service_name()
    _svc_display_name_ = self.get_default_service_name()
    ...
    def SvcDoRun(self):
        ...
        '''
        self._svc_display_name_ = self.get_default_service_name()
        self._svc_name_= self.get_default_service_name()
    ...
    def get_default_service_name(self):
        '''
        Returns the class name of the child instance.
        Is used by default for the service name in SCM.
        ~ https://stackoverflow.com/a/11408458
        '''
