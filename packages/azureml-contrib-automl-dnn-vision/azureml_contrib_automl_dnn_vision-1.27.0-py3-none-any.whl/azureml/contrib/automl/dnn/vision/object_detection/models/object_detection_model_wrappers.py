...
from azureml.contrib.automl.dnn.vision.common.constants import ArtifactLiterals, PretrainedModelNames
...
from azureml.contrib.automl.dnn.vision.object_detection.common.constants import ModelNames, ModelLiterals, \
    RetinaNetLiterals
...
class FasterRCNNResnet50FPNWrapper(FasterRCNNResnetFPNWrapper):
    ...
    def __init__(self, number_of_classes, model_state=None, specs=None,
        ...
        super().__init__(model_name=ModelNames.FASTER_RCNN_RESNET50_FPN,
                         number_of_classes=number_of_classes, specs=specs,
                         model_settings=model_settings)

    def _model_constructor(self, pretrained, load_pretrained_model_dict, **kwargs):

        return PretrainedModelFactory.fasterrcnn_resnet50_fpn(pretrained,
...
class FasterRCNNResnet34FPNWrapper(FasterRCNNResnetFPNWrapper):
    ...
    def _model_constructor(self, pretrained, load_pretrained_model_dict, **kwargs):
        ...
        return PretrainedModelFactory.fasterrcnn_resnet34_fpn(pretrained,
                                                              load_pretrained_model_dict,
                                                              **kwargs)
...
class FasterRCNNResnet18FPNWrapper(FasterRCNNResnetFPNWrapper):
    ...
    def _model_constructor(self, pretrained, load_pretrained_model_dict, **kwargs):
        ...
        return PretrainedModelFactory.fasterrcnn_resnet18_fpn(pretrained,
                                                              load_pretrained_model_dict,
                                                              **kwargs)
