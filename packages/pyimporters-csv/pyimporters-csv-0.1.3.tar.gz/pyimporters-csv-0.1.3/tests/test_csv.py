...
from pyimporters_csv.csv import CSVKnowledgeParser, CSVOptions, CSVOptionsModel
...
def test_csv():
    ...
    options = CSVOptionsModel(encoding="utf-8", identifier_col="ID", preferredForm_col="prefLabel_en", altForms_cols="altLabel_en", multivalue_separator="|")
