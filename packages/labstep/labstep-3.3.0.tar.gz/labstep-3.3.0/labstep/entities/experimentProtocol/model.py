...
class ExperimentProtocol(Entity):
    ...
    def export(self, rootPath, folderName=None, nameInFolderName=True):
        from labstep.entities.experimentProtocol.repository import experimentProtocolRepository
        return experimentProtocolRepository.exportExperimentProtocol(self, rootPath, folderName=folderName, nameInFolderName=nameInFolderName)
