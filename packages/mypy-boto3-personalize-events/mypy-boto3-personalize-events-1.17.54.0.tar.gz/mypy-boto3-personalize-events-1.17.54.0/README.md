...
[boto3.PersonalizeEvents 1.17.54](https://boto3.amazonaws.com/v1/documentation/api/1.17.54/reference/services/personalize-events.html#PersonalizeEvents) service
compatible with
