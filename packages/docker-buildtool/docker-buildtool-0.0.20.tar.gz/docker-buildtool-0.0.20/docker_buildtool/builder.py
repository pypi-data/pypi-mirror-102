...
class Builder(object):
    def __init__(self, dockerfile, image, variables=None, fetch=False, default_build_root=None, quiet=False, s3_location=None, run_docker_build=True, docker_args=[], force_rsync=False, safe_dockerignore=False):
    ...
    def run(self, dryrun):
        ...
        build = docker_build.DockerBuild(
            ...
            safe_dockerignore=self.safe_dockerignore,
        )
