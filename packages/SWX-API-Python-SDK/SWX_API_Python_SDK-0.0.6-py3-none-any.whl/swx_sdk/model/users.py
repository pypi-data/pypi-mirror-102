...
class Users(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] ([User]): Array of users. It doesn't include created_at and updated_at fields..  # noqa: E501

        Keyword Args:
            value ([User]): Array of users. It doesn't include created_at and updated_at fields..  # noqa: E501
