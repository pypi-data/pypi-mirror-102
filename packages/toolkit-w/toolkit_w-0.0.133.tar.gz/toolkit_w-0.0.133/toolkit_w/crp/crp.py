...
# --------------------------------------------------------------------------------------------------------------------------
 ...
 #---------------------------------------------------------------------------------------------------------------------------
    ...
    def getTotalSpentLMonth(self,train_df,dateFlag_sep,df_matrix):
        ...
        last_month_spent = last_month_df.groupby('customerid').agg({'totalprice':'sum'}).reset_index()
...
# ----------------------------------------------------------------------------------
    ...
    def getFeaturesMatrix(self,train_df,org_df,timeFlag,items_dataset):
        """
        Params:
...
# ------------------------------------------------------------------------------------------------------------------------------------
    ...
    def prepareDF(self,original_dataset,dateFlag_sep,date_flag_min,lag,items_dataset):
        ...
        # Calculate features
        df = self.getFeaturesMatrix(train_data,original_dataset,lag,items_dataset)
...
# -----------------------------------------------------------------------------------------------
    ...
    def buildDF(self,original_dataset,lag,train_window,items_dataset):
        """
        Params:
