...
@jsii.interface(jsii_type="aws-cdk-lib.aws_apigatewayv2.IWebSocketRouteIntegration")
...
class _IWebSocketRouteIntegrationProxy:
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.aws_apigatewayv2.IWebSocketRouteIntegration"
