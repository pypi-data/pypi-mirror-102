...
class HttpHeaderMatch(
    metaclass=jsii.JSIIAbstractClass,
    jsii_type="aws-cdk-lib.aws_appmesh.HttpHeaderMatch",
):
    ...
    @jsii.member(jsii_name="bind") # type: ignore[misc]
    @abc.abstractmethod
    def bind(self, scope: constructs.Construct) -> "HttpHeaderMatchConfig":
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.aws_appmesh.HttpHeaderMatchConfig",
    jsii_struct_bases=[],
...
@jsii.enum(jsii_type="aws-cdk-lib.aws_appmesh.HttpRouteMatchMethod")
...
class AcmTrustOptions(ClientPolicyOptions):
    ...
    @builtins.property
    def certificate_authorities(self) -> typing.List[_ICertificateAuthority_26727cab]:
        ...
        return typing.cast(typing.List[_ICertificateAuthority_26727cab], result)
