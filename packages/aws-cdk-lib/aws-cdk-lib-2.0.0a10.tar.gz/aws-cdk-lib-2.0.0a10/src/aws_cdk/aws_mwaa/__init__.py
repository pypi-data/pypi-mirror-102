...
class CfnEnvironment(
    ...
    def __init__(
        ...
        *,
        name: builtins.str,
        airflow_configuration_options: typing.Optional[typing.Union["CfnEnvironment.AirflowConfigurationOptionsProperty", _IResolvable_da3f097b]] = None,
    ...
    def airflow_configuration_options(
        self,
    ) -> typing.Optional[typing.Union["CfnEnvironment.AirflowConfigurationOptionsProperty", _IResolvable_da3f097b]]:
        ...
        '''
        return typing.cast(typing.Optional[typing.Union["CfnEnvironment.AirflowConfigurationOptionsProperty", _IResolvable_da3f097b]], jsii.get(self, "airflowConfigurationOptions"))

    @airflow_configuration_options.setter
    def airflow_configuration_options(
        self,
        value: typing.Optional[typing.Union["CfnEnvironment.AirflowConfigurationOptionsProperty", _IResolvable_da3f097b]],
    ) -> None:
...
class CfnEnvironmentProps:
    ...
    def airflow_configuration_options(
        ...
        return typing.cast(typing.Optional[typing.Union[CfnEnvironment.AirflowConfigurationOptionsProperty, _IResolvable_da3f097b]], result)
