...
class Cluster(metaclass=jsii.JSIIMeta, jsii_type="aws-cdk-lib.aws_msk.Cluster"):
...
@jsii.interface(jsii_type="aws-cdk-lib.aws_msk.ICluster")
...
class _IClusterProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.aws_msk.ICluster"
