...
from ..aws_codebuild import BuildSpec as _BuildSpec_4961ea5b
...
class CodeCommitSourceCodeProviderProps:
    def __init__(self, *, repository: _IRepository_e7c062a1) -> None:
...
class Domain(
    ...
    def __init__(
        ...
        *,
        app: "IApp",
        auto_sub_domain_iam_role: typing.Optional[_IRole_235f5d8e] = None,
    ...
    def domain_enable_auto_sub_domain(self) -> _IResolvable_da3f097b:
        '''(experimental) Specifies whether the automated creation of subdomains for branches is enabled.

        :stability: experimental
        :attribute: true
        '''
        return typing.cast(_IResolvable_da3f097b, jsii.get(self, "domainEnableAutoSubDomain"))
...
class DomainProps(DomainOptions):
    ...
    @builtins.property
    def auto_sub_domain_iam_role(self) -> typing.Optional[_IRole_235f5d8e]:
...
class IApp(_IResource_c80c4260, typing_extensions.Protocol):
...
class IBranch(_IResource_c80c4260, typing_extensions.Protocol):
...
class SourceCodeProviderConfig:
    def __init__(
        ...
        *,
        repository: builtins.str,
        access_token: typing.Optional[_SecretValue_3dd0ddae] = None,
        oauth_token: typing.Optional[_SecretValue_3dd0ddae] = None,
    ) -> None:
    ...
    @builtins.property
    def access_token(self) -> typing.Optional[_SecretValue_3dd0ddae]:
    ...
    @builtins.property
    def oauth_token(self) -> typing.Optional[_SecretValue_3dd0ddae]:
...
@jsii.implements(IApp, _IGrantable_71c4f5de)
class App(
    _Resource_45bc6135,
    metaclass=jsii.JSIIMeta,
