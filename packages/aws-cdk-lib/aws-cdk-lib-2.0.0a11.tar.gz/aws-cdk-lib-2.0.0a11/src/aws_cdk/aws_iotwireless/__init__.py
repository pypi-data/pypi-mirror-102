...
class CfnServiceProfile(
    ...
    def attr_hr_allowed(self) -> _IResolvable_da3f097b:
        '''
        :cloudformationAttribute: HrAllowed
        '''
        return typing.cast(_IResolvable_da3f097b, jsii.get(self, "attrHrAllowed"))
    ...
    def attr_nwk_geo_loc(self) -> _IResolvable_da3f097b:
        '''
        :cloudformationAttribute: NwkGeoLoc
        '''
        return typing.cast(_IResolvable_da3f097b, jsii.get(self, "attrNwkGeoLoc"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="attrPrAllowed")
    def attr_pr_allowed(self) -> _IResolvable_da3f097b:
        '''
        :cloudformationAttribute: PrAllowed
        '''
        return typing.cast(_IResolvable_da3f097b, jsii.get(self, "attrPrAllowed"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="attrRaAllowed")
    def attr_ra_allowed(self) -> _IResolvable_da3f097b:
        '''
        :cloudformationAttribute: RaAllowed
        '''
        return typing.cast(_IResolvable_da3f097b, jsii.get(self, "attrRaAllowed"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="attrReportDevStatusBattery")
    def attr_report_dev_status_battery(self) -> _IResolvable_da3f097b:
        '''
        :cloudformationAttribute: ReportDevStatusBattery
        '''
        return typing.cast(_IResolvable_da3f097b, jsii.get(self, "attrReportDevStatusBattery"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="attrReportDevStatusMargin")
    def attr_report_dev_status_margin(self) -> _IResolvable_da3f097b:
        '''
        :cloudformationAttribute: ReportDevStatusMargin
        '''
        return typing.cast(_IResolvable_da3f097b, jsii.get(self, "attrReportDevStatusMargin"))
