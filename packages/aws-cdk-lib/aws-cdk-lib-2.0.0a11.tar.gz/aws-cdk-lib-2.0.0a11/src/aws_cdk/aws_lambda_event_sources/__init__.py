...
from ..aws_msk import ICluster as _ICluster_46c62520
from ..aws_s3 import (
...
class ManagedKafkaEventSourceProps(KafkaEventSourceProps):
    ...
    @builtins.property
    def cluster(self) -> _ICluster_46c62520:
        ...
        return typing.cast(_ICluster_46c62520, result)
