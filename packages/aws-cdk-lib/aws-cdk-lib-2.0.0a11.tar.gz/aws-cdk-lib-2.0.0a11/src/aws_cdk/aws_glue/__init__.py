...
from ..aws_ec2 import (
    ISecurityGroup as _ISecurityGroup_acf8a799, ISubnet as _ISubnet_d57d1229
)
...
class ConnectionOptions:
    def __init__(
        ...
        *,
        ...
        subnet: typing.Optional[_ISubnet_d57d1229] = None,
    ) -> None:
    ...
    @builtins.property
    def subnet(self) -> typing.Optional[_ISubnet_d57d1229]:
        ...
        return typing.cast(typing.Optional[_ISubnet_d57d1229], result)
...
class IDatabase(_IResource_c80c4260, typing_extensions.Protocol):
    '''
    :stability: experimental
    '''
...
class ISecurityConfiguration(_IResource_c80c4260, typing_extensions.Protocol):
...
class SecurityConfiguration(
    ...
    def cloud_watch_encryption_key(self) -> typing.Optional[_IKey_5f11635f]:
        '''(experimental) The KMS key used in CloudWatch encryption if it requires a kms key.

        :stability: experimental
        '''
        return typing.cast(typing.Optional[_IKey_5f11635f], jsii.get(self, "cloudWatchEncryptionKey"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="jobBookmarksEncryptionKey")
    def job_bookmarks_encryption_key(self) -> typing.Optional[_IKey_5f11635f]:
        '''(experimental) The KMS key used in job bookmarks encryption if it requires a kms key.

        :stability: experimental
        '''
        return typing.cast(typing.Optional[_IKey_5f11635f], jsii.get(self, "jobBookmarksEncryptionKey"))

    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="s3EncryptionKey")
    def s3_encryption_key(self) -> typing.Optional[_IKey_5f11635f]:
        '''(experimental) The KMS key used in S3 encryption if it requires a kms key.

        :stability: experimental
        '''
        return typing.cast(typing.Optional[_IKey_5f11635f], jsii.get(self, "s3EncryptionKey"))
