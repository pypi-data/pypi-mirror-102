...
class IChannel(_IResource_c80c4260, typing_extensions.Protocol):
...
class IPlaybackKeyPair(_IResource_c80c4260, typing_extensions.Protocol):
...
class IStreamKey(_IResource_c80c4260, typing_extensions.Protocol):
