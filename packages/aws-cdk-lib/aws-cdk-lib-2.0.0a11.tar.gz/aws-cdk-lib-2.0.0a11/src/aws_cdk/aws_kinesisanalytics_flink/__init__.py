...
from ..aws_kinesisanalytics import CfnApplicationV2 as _CfnApplicationV2_f3268a92
...
class ApplicationCodeConfig:
    def __init__(
        self,
        *,
        application_code_configuration_property: _CfnApplicationV2_f3268a92.ApplicationConfigurationProperty,
        bucket: _IBucket_42e086fd,
    ) -> None:
        ...
        if isinstance(application_code_configuration_property, dict):
            application_code_configuration_property = _CfnApplicationV2_f3268a92.ApplicationConfigurationProperty(**application_code_configuration_property)
    ...
    def application_code_configuration_property(
        self,
    ) -> _CfnApplicationV2_f3268a92.ApplicationConfigurationProperty:
        ...
        return typing.cast(_CfnApplicationV2_f3268a92.ApplicationConfigurationProperty, result)
...
class ApplicationProps:
    def __init__(
        ...
        *,
        ...
        checkpoint_interval: typing.Optional[_Duration_4839e8c3] = None,
        ...
        min_pause_between_checkpoints: typing.Optional[_Duration_4839e8c3] = None,
    ...
    @builtins.property
    def checkpoint_interval(self) -> typing.Optional[_Duration_4839e8c3]:
    ...
    @builtins.property
    def min_pause_between_checkpoints(self) -> typing.Optional[_Duration_4839e8c3]:
