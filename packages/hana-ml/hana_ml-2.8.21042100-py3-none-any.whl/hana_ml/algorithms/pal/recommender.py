...
class ALS(PALBase):
    ...
    def predict(self, data, key, usr=None, item=None, thread_ratio=None):
        """
...
class FRM(PALBase):
    ...
    def predict(self, data, usr_info, item_info, key, usr=None, item=None, features=None, thread_ratio=None):
        """
...
class _FFMBase(PALBase):
    ...
    def _predict(self, data, key, features=None, thread_ratio=None, handle_missing=None):
        conn = data.connection_context
        require_pal_usable(conn)
        if getattr(self, 'model_') is None:
...
class FFMClassifier(_FFMBase):
    ...
    def predict(self, data, key, features=None, thread_ratio=None, handle_missing=None):
        """
