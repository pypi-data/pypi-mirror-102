...
class HorizontalCylinder(FloatingBody):
    ...
    def __init__(self, length=10.0, radius=1.0, center=(0, 0, 0),
        ...
        if nr > 0:
            ...
            mesh = CollectionOfMeshes((open_cylinder, CollectionOfMeshes(side, other_side)))
    ...
    def _generate_open_cylinder_mesh(self, nx, ntheta, name=None):
        ...
        if nx == 1:
            ...
            return TranslationalSymmetricMesh(ring.merged(), translation=np.asarray([self.length / nx, 0.0, 0.0]),
