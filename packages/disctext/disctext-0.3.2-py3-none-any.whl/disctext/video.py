...
def maximize(vid: Video):
    h, w, c, a = (vid.height,  vid.width,
                  vid.columns, vid.area)
...
class Canvas(Op):
    ...
    def __init__(self, vid: Video, source: Event = None):
        Op.__init__(self, source)
        self.video = vid
        self.wspace = vid.pixels.index(" ")
        self.minimum = vid.area.min
