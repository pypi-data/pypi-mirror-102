...
[boto3.CodeStarconnections 1.17.54](https://boto3.amazonaws.com/v1/documentation/api/1.17.54/reference/services/codestar-connections.html#CodeStarconnections) service
compatible with
