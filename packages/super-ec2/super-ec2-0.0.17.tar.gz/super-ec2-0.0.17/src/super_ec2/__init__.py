...
class IDomainProps(typing_extensions.Protocol):
    ...
    def __jsii_proxy_class__() -> typing.Type["_IDomainPropsProxy"]:
        return _IDomainPropsProxy
...
class ISuperDomainProps(IDomainProps, typing_extensions.Protocol):
    ...
    @builtins.staticmethod
    def __jsii_proxy_class__() -> typing.Type["_ISuperDomainPropsProxy"]:
        return _ISuperDomainPropsProxy
