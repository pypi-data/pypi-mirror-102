define([
    ...
    */
    ...
    BlockContainer.prototype.resizeAPIblock = function() {
        ...
        var optionPageRectWidth = mainPageRectWidthNum - boardPageRectWidth - buttonsPageRectWidth - 23;

        if (optionPageRectWidth < NUM_OPTION_PAGE_WIDTH) {
            boardPageRectWidth = mainPageRectWidthNum - NUM_OPTION_PAGE_WIDTH - 23 - buttonsPageRectWidth;
            optionPageRectWidth = NUM_OPTION_PAGE_WIDTH;
        } 
        
        var optionPageRectWidth_maxWidth = mainPageRectWidthNum - buttonsPageRectWidth - NUM_API_BOARD_CENTER_PAGE_MIN_WIDTH - 23;
    ...
    */
    ...
    BlockContainer.prototype.resetOptionPage = function() {
        ...
        this.setNavigator(BLOCK_CODELINE_TYPE.NONE, 'Visual Python 1.0.6');
