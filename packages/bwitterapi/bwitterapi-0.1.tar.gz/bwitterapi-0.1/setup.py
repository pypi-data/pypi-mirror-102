...
setup(
  name = "bwitterapi",         # How you named your package folder (MyLib)
  packages = ['bwitterapi'],   # Chose the same as "name"
  version = '0.1',      # Start with a small number and increase it with every change you make
  license='LGPL 3.0',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  description = 'A Bwitter poster api',   # Give a short description about your library
  ...
  keywords = ['bwitter', 'bwitter-poster', 'bwitterapi'],   # Keywords that define your package best
