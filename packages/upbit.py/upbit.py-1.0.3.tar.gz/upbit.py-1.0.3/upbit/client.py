...
class Client(API):
    ...
    def get_candles_minutes(self, unit: int = 1, market: str = KRW_BTC, to: Optional[str] = None, count: Optional[int] = None) -> list[dict]:
    ...
    def get_candles_days(self, market: str = KRW_BTC, to: Optional[str] = None, count: Optional[int] = None, converting_price_unit: Optional[str] = None) -> list[dict]:
    ...
    def get_candles_weeks(self, market: str = KRW_BTC, to: Optional[str] = None, count: Optional[int] = None) -> list[dict]:
    ...
    def get_candles_months(self, market: str = KRW_BTC, to: Optional[str] = None, count: Optional[int] = None) -> list[dict]:
    ...
    def get_trades(self, market: str = KRW_BTC, to: Optional[str] = None, count: Optional[int] = None, cursor: Optional[str] = None, days_ago: Optional[int] = None) -> list[dict]:
    ...
    def get_tickers(self, markets: list[str] = [KRW_BTC]) -> list[dict]:
        return super().call_api('get', '/ticker', data={
            'markets': markets
        })

    def get_orderbooks(self, markets: list[str] = [KRW_BTC]) -> list[dict]:
    ...
    def get_orders_chance(self, market: str = KRW_BTC) -> dict:
    ...
    def order(self, market: str = KRW_BTC, side: str = 'bid', volume: Optional[str] = None, price: Optional[str] = None, ord_type: str = 'limit', identifier: Optional[str] = None) -> dict:
    ...
    def get_withdraws_chance(self, currency: str = KRW_BTC) -> dict:
