...
/*
    Make sure that this is the width as suggestion-box-container 
    in suggestion-box.css and the text editor in mitosheet.css
*/ 
export const LAST_COLUMN_DEFAULT_WIDTH = 300; 
