...
export class MitoAPI {
    ...
    */
    ...
    /*
        Sends the indended behavior that the user has to the backend
    */
    async sendIntendedBehavior(
        intendededBehaviors: string[]
    ): Promise<void> {
        this.send({
            'event': 'update_event',
            'type': 'set_user_field_update',
            'field': 'intended_behavior',
            'value': intendededBehaviors
        });
    }
    ...
    */
    async sendCloseTour(tourName: string): Promise<void> {
        this.send({
            'event': 'update_event',
            'type': 'close_tour_update',
            'received_tour': tourName
        })
    }
