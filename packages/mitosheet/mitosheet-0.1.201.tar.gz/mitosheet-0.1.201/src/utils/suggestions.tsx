...
export function endsInColumnHeader(
    ...
    return columns.findIndex((columnHeader) => columnHeader.toUpperCase() === endingColumnHeader.toUpperCase()) >= 0;
}
...
export function getColumnHeaderSuggestions(
    ...
    const matchingColumnHeaders = columns.filter((columnHeader) => {
        return (typeof columnHeader == 'string') && (columnHeader.toUpperCase().startsWith(endingColumnHeader.toUpperCase()));
    }) as string[];
