...
type MitoState = {
    ...
    */
    ...
    displayTour: boolean;
    highlightPivotTableButton: boolean; // This is used by the tour to highlight the pivot button in the toolbar
};
...
class Mito extends React.Component<MitoProps, MitoState> {
    ...
    */
    ...
    /* Used the by the tour to highlight */
    ...
    render() {
        ...
        return (
            <div className="mito-container" ref={(ref) => {
                ...
                {this.state.displayTour && this.state.modalInfo.type !== ModalEnum.SignUp &&
                    <Tour 
