...
const MitoSheet = (props: {
    ...
    */
    ...
    const columns = buildGridColumns(
        ...
        props.setSelectedColumnControlPanelTab
    );
            ...
            <div className="ag-theme-alpine mitosheet-ag-grid"> 
                <AgGridReact
                    ...
                    overlayNoRowsTemplate={
                        '<span style="font-size: 20px; color: #343434;">  Import data to start using Mito. <br /> Use the import button in the Mitosheet toolbar above.</span>'
                    }
                    rowData={rowData}
                    rowHeight={25}
