...
const SuggestionBox = (
    props: {
        ...
        onSelectSuggestion: (startOfFunction: string, restOfFunction: string, type: SuggestionType, fullSuggestion?: string) => void
    }): JSX.Element => {
        ...
        if (idx === selectedIndex) {
            return (
                <div 
                    ...
                    onClick={() => {props.onSelectSuggestion(suggestionObject.match, restOfSuggestion, suggestionObject.type, suggestionObject.suggestion)}}
                >
