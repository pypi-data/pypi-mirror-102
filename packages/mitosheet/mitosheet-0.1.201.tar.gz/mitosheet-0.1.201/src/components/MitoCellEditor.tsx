...
import { endsInColumnHeader, getColumnHeaderSuggestions, getFunctionSuggestions } from '../utils/suggestions';
...
export default class MitoCellEditor extends Component<CellEditorProps, CellEditorState> {
        ...
        */
        ...
        if (suggestions !== undefined) {
            if (TAKE_SUGGESTION_KEYS.includes(event.key)) {
                ...
                return this.selectSuggestion(selectedSuggestion.match, restOfSuggestion, selectedSuggestion.type, selectedSuggestion.suggestion);
    ...
    */
    ...
    selectSuggestion(endingString: string, restOfSuggestion: string, type: SuggestionType, fullSuggestion?: string): void {
        ...
        } else if (fullSuggestion !== undefined) {
            // Add column header, if column header
            newFormula = stripped + fullSuggestion;
        } else {
