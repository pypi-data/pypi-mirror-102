...
[boto3.ConnectParticipant 1.17.54](https://boto3.amazonaws.com/v1/documentation/api/1.17.54/reference/services/connectparticipant.html#ConnectParticipant) service
compatible with
