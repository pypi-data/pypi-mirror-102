...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'eks', '0.23.1-alpha.1618595873+41eb5651'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource eks 0.23.1-alpha.1618595873+41eb5651`
                """)
            else:
                raise
