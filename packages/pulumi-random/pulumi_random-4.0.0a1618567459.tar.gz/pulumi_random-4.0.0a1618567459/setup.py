...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'random', '4.0.0-alpha.1618567459+515500a9'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource random 4.0.0-alpha.1618567459+515500a9`
                """)
            else:
                raise
