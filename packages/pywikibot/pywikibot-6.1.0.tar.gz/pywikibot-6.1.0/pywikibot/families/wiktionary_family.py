...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'eu', 'uk', 'br', 'da', 'ast', 'lo', 'simple', 'is', 'hr', 'la', 'fj',
        'tg', 'ky', 'sk', 'bg', 'wa', 'ur', 'ps', 'skr', 'cy', 'vo', 'he',
        'af', 'zh-min-nan', 'shn', 'scn', 'sl', 'tl', 'pa', 'sw', 'fy', 'bn',
        'nn', 'ka', 'lv', 'sq', 'co', 'min', 'mn', 'pnb', 'nds', 'lb', 'bs',
        'om', 'ms', 'nah', 'yue', 'sa', 'kk', 'km', 'diq', 'vec', 'tk', 'be',
        'mk', 'sm', 'hsb', 'shy', 'gd', 'ga', 'an', 'wo', 'mni', 'gom', 'mr',
        'ang', 'ia', 'nia', 'tt', 'fo', 'mt', 'sd', 'gn', 'ie', 'so', 'csb',
        'ug', 'bcl', 'st', 'roa-rup', 'si', 'hif', 'zu', 'kl', 'su', 'mi',
        'ay', 'jbo', 'ln', 'yi', 'gu', 'na', 'gv', 'kw', 'mnw', 'tpi', 'ne',
        'rw', 'ts', 'qu', 'ha', 'ss', 'chr', 'ks', 'iu', 'am', 'dv', 'sg',
        'ti', 'tn',
    ]
