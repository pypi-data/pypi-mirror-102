...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'ja', 'vi', 'arz', 'zh', 'ar', 'uk', 'pt', 'fa', 'ca', 'sr', 'id',
        'no', 'ko', 'fi', 'hu', 'cs', 'sh', 'zh-min-nan', 'ro', 'tr', 'eu',
        'ce', 'ms', 'eo', 'he', 'hy', 'bg', 'tt', 'da', 'azb', 'sk', 'kk',
        'min', 'et', 'hr', 'be', 'lt', 'el', 'simple', 'az', 'gl', 'sl', 'ur',
        'nn', 'ka', 'hi', 'uz', 'th', 'ta', 'la', 'cy', 'vo', 'ast', 'mk',
        'zh-yue', 'lv', 'bn', 'tg', 'my', 'af', 'mg', 'oc', 'bs', 'sq', 'nds',
        'ky', 'be-tarask', 'ml', 'new', 'mr', 'te', 'br', 'vec', 'pms', 'jv',
        'ht', 'pnb', 'sw', 'su', 'lb', 'ba', 'tl', 'ga', 'szl', 'is', 'lmo',
        'cv', 'fy', 'wuu', 'sco', 'diq', 'an', 'ku', 'pa', 'yo', 'ne', 'bar',
        'io', 'ckb', 'gu', 'als', 'kn', 'scn', 'bpy', 'ia', 'qu', 'mn', 'si',
        'bat-smg', 'nv', 'xmf', 'or', 'cdo', 'ilo', 'gd', 'yi', 'am', 'nap',
        'sd', 'bug', 'hsb', 'mai', 'fo', 'map-bms', 'avk', 'mzn', 'li', 'os',
        'sah', 'frr', 'eml', 'ace', 'ps', 'sa', 'gor', 'bcl', 'wa',
        'zh-classical', 'mrj', 'lij', 'mhr', 'hif', 'hak', 'roa-tara', 'crh',
        'pam', 'hyw', 'shn', 'ha', 'as', 'nso', 'km', 'rue', 'zu', 'se', 'bh',
        'vls', 'nds-nl', 'mi', 'nah', 'ban', 'sc', 'sn', 'vep', 'gan', 'myv',
        'glk', 'kab', 'ab', 'ie', 'so', 'sat', 'bo', 'co', 'tk', 'fiu-vro',
        'kv', 'csb', 'pcd', 'gv', 'udm', 'ug', 'ay', 'frp', 'zea', 'nrm', 'kw',
        'lez', 'gn', 'lfn', 'stq', 'mwl', 'mt', 'rm', 'lo', 'ary', 'lad',
        'skr', 'olo', 'gom', 'bjn', 'koi', 'fur', 'ang', 'dty', 'dsb', 'ext',
        'ln', 'tyv', 'cbk-zam', 'dv', 'ksh', 'mni', 'smn', 'gag', 'pfl', 'pag',
        'pi', 'av', 'awa', 'tay', 'haw', 'bxr', 'pap', 'xal', 'ig', 'krc',
        'rw', 'za', 'pdc', 'kaa', 'szy', 'arc', 'to', 'inh', 'nov', 'kbp',
        'jam', 'tpi', 'wo', 'kbd', 'na', 'atj', 'ki', 'tet', 'tcy', 'ak',
        'lld', 'lg', 'jbo', 'roa-rup', 'bi', 'lbe', 'kg', 'ty', 'mdf', 'xh',
        'fj', 'srn', 'om', 'gcr', 'trv', 'ltg', 'sm', 'nqo', 'chr', 'nia',
        'pih', 'mnw', 'got', 'st', 'kl', 'cu', 'mad', 'ny', 'tw', 'tn', 'ts',
        'bm', 'rmy', 'chy', 'rn', 'tum', 've', 'ss', 'ch', 'iu', 'ks', 'pnt',
        'ady', 'alt', 'ee', 'ik', 'ff', 'sg', 'din', 'dz', 'ti', 'cr',
    ]
