...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gitlab', '4.0.0-alpha.1618782827+3955c5d6'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gitlab 4.0.0-alpha.1618782827+3955c5d6`
                """)
            else:
                raise
