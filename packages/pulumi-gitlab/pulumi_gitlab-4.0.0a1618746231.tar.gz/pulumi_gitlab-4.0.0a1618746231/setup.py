...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gitlab', '4.0.0-alpha.1618746231+cc81f141'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gitlab 4.0.0-alpha.1618746231+cc81f141`
                """)
            else:
                raise
