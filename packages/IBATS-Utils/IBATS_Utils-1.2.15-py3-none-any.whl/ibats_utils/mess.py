...
def get_folder_path(target_folder_name=None, create_if_not_found=True) -> typing.Optional[str]:
    """
    获得系统缓存目录路径
...
def is_sub_class(sub_cls: typing.ClassVar, cls: typing.ClassVar) -> bool:
    """检查某一个类是否是另一个类的子类"""
    is_ok = False
    try:
