...
class CfnExperimentTemplate(
    ...
    class ExperimentTemplateTargetFilterListProperty:
        def __init__(
            self,
            *,
            experiment_template_target_filter_list: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.Sequence[typing.Union[aws_cdk.core.IResolvable, "CfnExperimentTemplate.ExperimentTemplateTargetFilterProperty"]]]] = None,
        ) -> None:
            '''
