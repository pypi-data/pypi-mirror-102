...
nv_settings = {
    ...
    'serverless_api_url': os.environ.get("NV_SERVERLESS_API_URL") or "https://clients.sls.nerd.vision",
    ...
    'event_snapshot_api': os.environ.get("NV_EVENT_SNAPSHOT_API") or "/context/v2/",
    ...
    'error_ingest_url': os.environ.get("NV_ERROR_INGEST_URL") or None,
...
def get_error_url():
    url = (nv_settings['error_ingest_url'] or nv_settings['serverless_api_url'])
