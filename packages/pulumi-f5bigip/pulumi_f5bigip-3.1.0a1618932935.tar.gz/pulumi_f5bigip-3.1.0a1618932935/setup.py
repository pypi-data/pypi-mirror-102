...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'f5bigip', '3.1.0-alpha.1618932935+b1eb6118'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource f5bigip 3.1.0-alpha.1618932935+b1eb6118`
                """)
            else:
                raise
