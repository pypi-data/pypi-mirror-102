...
from ..common import raise_exception, MULTISPHERE_ID
...
class Polymatica57():
    ...
    def run_scenario_impl(self, **kwargs):
        ...
        # TODO: имена в кириллице косо отображаются на интерфейсе, надо пофиксить
        self.base_bs.execute_manager_command(
            command_name="user_layer", state="rename_layer", layer_id=layer_uuid, name="Script layer")
