...
class ActionParams(google___protobuf___message___Message):
    ...
    def HasField(self, field_name: typing_extensions___Literal[u"charge_refund_params",b"charge_refund_params",u"params",b"params",u"subscription_trial_update_params",b"subscription_trial_update_params",u"webhook_params",b"webhook_params"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"charge_refund_params",b"charge_refund_params",u"params",b"params",u"subscription_trial_update_params",b"subscription_trial_update_params",u"webhook_params",b"webhook_params"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"params",b"params"]) -> typing_extensions___Literal["charge_refund_params","subscription_trial_update_params","webhook_params"]: ...
...
class ActionConfig(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"action_state",b"action_state",u"created_by_organization_user",b"created_by_organization_user",u"default_action_params",b"default_action_params",u"entity_type",b"entity_type",u"source",b"source",u"title",b"title"]) -> None: ...
