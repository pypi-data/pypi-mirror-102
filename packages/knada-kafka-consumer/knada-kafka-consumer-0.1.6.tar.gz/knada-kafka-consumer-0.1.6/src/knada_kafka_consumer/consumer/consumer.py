...
class ConsumerApp:
    ...
    def add_endpoints(self):
        self._app.add_api_route(path="/metrics", endpoint=self.healthyness)
    ...
    def create_consumer(self) -> KafkaConsumer:
        return KafkaConsumer(self._topic,
