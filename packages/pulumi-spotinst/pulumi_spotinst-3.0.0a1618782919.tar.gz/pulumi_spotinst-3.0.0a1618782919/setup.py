...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', '3.0.0-alpha.1618782919+1b2dc677'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst 3.0.0-alpha.1618782919+1b2dc677`
                """)
            else:
                raise
