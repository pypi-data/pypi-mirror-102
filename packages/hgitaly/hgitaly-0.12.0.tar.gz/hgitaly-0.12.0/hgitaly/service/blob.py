...
CHUNK_SIZE = 16 * 1024
"""Size of binary chunks.

TODO: make a generic binary chunker
TODO: why is this differnent in practice than stream.WRITE_BUFFER_SIZE
      (16k instead of 128k)?
"""
...
def iter_blob_chunks(data, chunk_size=CHUNK_SIZE):
