...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '4.0.0-alpha.1618782935+d7ae1e0e'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 4.0.0-alpha.1618782935+d7ae1e0e`
                """)
            else:
                raise
