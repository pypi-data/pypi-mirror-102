...
class Transfer(object):
    ...
    def __init__(self, storage_key=None, time_index=0, input_amount=0, output_amount=0, local_vars_configuration=None):  # noqa: E501
    ...
    def time_index(self, time_index):
        ...
        if (self.local_vars_configuration.client_side_validation and
                time_index is not None and time_index > 60):  # noqa: E501
            raise ValueError("Invalid value for `time_index`, must be a value less than or equal to `60`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
