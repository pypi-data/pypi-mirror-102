...
class CfnMonitoringSchedule(
    ...
    class MonitoringInputsProperty:
        def __init__(
            self,
            *,
            monitoring_inputs: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union["CfnMonitoringSchedule.MonitoringInputProperty", _IResolvable_a771d0ef]]]] = None,
        ) -> None:
            '''
