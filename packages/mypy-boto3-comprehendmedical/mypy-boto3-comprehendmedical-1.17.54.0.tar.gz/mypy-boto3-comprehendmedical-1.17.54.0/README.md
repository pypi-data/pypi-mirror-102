...
[boto3.ComprehendMedical 1.17.54](https://boto3.amazonaws.com/v1/documentation/api/1.17.54/reference/services/comprehendmedical.html#ComprehendMedical) service
compatible with
