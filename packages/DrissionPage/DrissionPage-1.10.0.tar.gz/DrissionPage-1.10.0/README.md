...
- text_value_index: Union[str, int, list, tuple]  -  select options based on text, value or serial number. If multiple selections are allowed, multiple selections can be made by inputting a list or tuple
...
- text_value_index: Union[str, int, list, tuple]  - deselect options based on text, value selection, or serial number. If multiple selections are allowed, multiple selections can be made by inputting a list or tuple
