...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'cloudamqp', '3.0.0-alpha.1618686903+e26e84de'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource cloudamqp 3.0.0-alpha.1618686903+e26e84de`
                """)
            else:
                raise
