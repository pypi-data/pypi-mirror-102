...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azuredevops', '2.0.0-alpha.1618499433+7b7df183'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azuredevops 2.0.0-alpha.1618499433+7b7df183`
                """)
            else:
                raise
