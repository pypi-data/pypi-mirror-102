...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azuredevops', '2.0.0-alpha.1618659731+1c75ff09'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azuredevops 2.0.0-alpha.1618659731+1c75ff09`
                """)
            else:
                raise
