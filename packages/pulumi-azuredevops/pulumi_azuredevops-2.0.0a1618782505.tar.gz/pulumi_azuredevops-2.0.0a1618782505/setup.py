...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azuredevops', '2.0.0-alpha.1618782505+79a64e91'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azuredevops 2.0.0-alpha.1618782505+79a64e91`
                """)
            else:
                raise
