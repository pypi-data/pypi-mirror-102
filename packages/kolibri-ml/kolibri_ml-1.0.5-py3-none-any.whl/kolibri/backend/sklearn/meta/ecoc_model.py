...
class EcocEstimator(BaseEstimator):
    ...
    def __init__(self, base_estimator="logistic-regression", code_size=1.0, random_state=42):

        self.base_estimator = self.load_model_from_parameters(get_model(base_estimator))
