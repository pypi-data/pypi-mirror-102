...
rejected_emails_formulas=open(resources.get('corpora/gazetteers/default/rejected_email.txt', encoding='utf-8').path).readlines()
sent_from_my_device=open(resources.get('corpora/gazetteers/default/sent_from_my_device.txt', encoding='utf-8').path).readlines()
email_caution_or_fron_content=open(resources.get('corpora/gazetteers/default/email_caution_or_front_content.txt', encoding='utf-8').path).readlines()
