...
class ANN(object):
    ...
    def __init__(self, host='10.46.242.23', port='19530', handler="HTTP", pool="SingletonThread", show_info=False):
        self.host = host
        self.client = Milvus(host, port, handler=handler, pool=pool)  # 线程池
