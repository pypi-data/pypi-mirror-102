...
def to_hdfs(
    ...
    if batch_size:
        ...
        enumerate(dfs, file_start_index) | xThreadPoolExecutor(_writer, 8) | xlist  # 多进程好像会卡死
        # enumerate(dfs, file_start_index) | xProcessPoolExecutor(_writer, 8) | xlist  # 多进程好像会卡死
