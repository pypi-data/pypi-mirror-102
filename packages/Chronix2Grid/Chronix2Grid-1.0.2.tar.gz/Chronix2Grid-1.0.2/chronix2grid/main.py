...
if __name__ == "__main__":
    ...
    # scenario_name = "january_test_nm" #"year_wind_solar" "january_wind_solar_dispatch"
    # seed_for_loads = 912206665 # 1114455947
    # seed_for_res = 912206665 # 1114455947
    # seed_for_dispatch = 912206665 # 1114455947
    # nb_core = 1
