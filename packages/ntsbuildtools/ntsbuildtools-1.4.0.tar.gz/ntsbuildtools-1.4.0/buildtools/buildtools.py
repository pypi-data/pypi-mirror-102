...
from buildtools.post_github_comment import PostGitHubPRComment
...
class BuildTools:
    def __init__(self):
        ...
        self.base_parser.add('--version', action='version', version=f"BuildTools Version: {__version__}")
...
def main(args):
    ...
    bt.register(PostGitHubPRComment())
