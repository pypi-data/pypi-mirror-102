...
export RADICAL_BASE="<Mock id='139750069953344'>"
export RP_SESSION_ID="sid0"
export RP_PILOT_ID="pid0"
export RP_AGENT_ID="aid0"
export RP_SPAWNER_ID="<Mock id='139750069953248'>"
export RP_TASK_ID="task.000000"
export RP_TASK_NAME="task.0000"
export RP_GTOD="<Mock id='139750069953296'>"
export RP_TMP="<Mock id='139750069953536'>"
export RP_PILOT_SANDBOX="<Mock id='139750069953344'>"
export RP_PILOT_STAGING="<Mock id='139750069953344'>"
