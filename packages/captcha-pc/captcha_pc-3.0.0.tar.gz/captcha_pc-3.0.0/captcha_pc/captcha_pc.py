...
def resolver_captcha_tipo1(username, password, token, imagem, timeout):
...
def resolver_captcha_tipo5(username, password, token, key, pageurl, action):
	...
	while texto == None or texto == "%3F":
		...
		#client = deathbycaptcha.SocketClient(username, password, token)
