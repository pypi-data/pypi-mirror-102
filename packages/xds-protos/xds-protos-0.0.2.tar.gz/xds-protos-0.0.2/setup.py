...
for proto_root_module in ['envoy', 'google', 'opencensus', 'udpa', 'validate', 'xds']:
...
PACKAGES=setuptools.find_packages(where=".", exclude=[TEST_FILE_NAME]) + setuptools.find_namespace_packages(include=['google.*'])
CLASSIFIERS = [
