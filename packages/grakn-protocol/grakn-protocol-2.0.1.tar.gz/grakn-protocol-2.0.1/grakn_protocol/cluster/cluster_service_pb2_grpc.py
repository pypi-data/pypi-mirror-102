...
class GraknClusterStub(object):
  ...
  def __init__(self, channel):
    ...
    self.servers_all = channel.unary_unary(
        '/grakn.protocol.GraknCluster/servers_all',
    ...
    self.databases_get = channel.unary_unary(
        '/grakn.protocol.GraknCluster/databases_get',
    ...
    self.databases_all = channel.unary_unary(
        '/grakn.protocol.GraknCluster/databases_all',
...
def add_GraknClusterServicer_to_server(servicer, server):
  ...
  generic_handler = grpc.method_handlers_generic_handler(
      'grakn.protocol.GraknCluster', rpc_method_handlers)
