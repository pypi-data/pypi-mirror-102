...
_SESSION_OPEN_RES = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='server_duration_millis', full_name='grakn.protocol.Session.Open.Res.server_duration_millis', index=1,
