...
_LOGICMANAGER_RESPART = _descriptor.Descriptor(
  name='ResPart',
  full_name='grakn.protocol.LogicManager.ResPart',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='get_rules_res_part', full_name='grakn.protocol.LogicManager.ResPart.get_rules_res_part', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LOGICMANAGER_GETRULES_RESPART = _descriptor.Descriptor(
  name='ResPart',
  full_name='grakn.protocol.LogicManager.GetRules.ResPart',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='rules', full_name='grakn.protocol.LogicManager.GetRules.ResPart.rules', index=0,
...
_EXPLANATION_VARMAPPINGENTRY = _descriptor.Descriptor(
  ...
  full_name='grakn.protocol.Explanation.VarMappingEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='grakn.protocol.Explanation.VarMappingEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='grakn.protocol.Explanation.VarMappingEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_EXPLANATION_VARLIST = _descriptor.Descriptor(
  name='VarList',
  full_name='grakn.protocol.Explanation.VarList',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='vars', full_name='grakn.protocol.Explanation.VarList.vars', index=0,
...
_EXPLANATION = _descriptor.Descriptor(
  name='Explanation',
  full_name='grakn.protocol.Explanation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='rule', full_name='grakn.protocol.Explanation.rule', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='rule', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='var_mapping', full_name='grakn.protocol.Explanation.var_mapping', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='condition', full_name='grakn.protocol.Explanation.condition', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='conclusion', full_name='grakn.protocol.Explanation.conclusion', index=3,
...
LogicManager = _reflection.GeneratedProtocolMessageType('LogicManager', (_message.Message,), dict(
  ...
  ResPart = _reflection.GeneratedProtocolMessageType('ResPart', (_message.Message,), dict(
    ...
    __module__ = 'common.logic_pb2'
    # @@protoc_insertion_point(class_scope:grakn.protocol.LogicManager.ResPart)
    ))
  ,
  ...
  GetRules = _reflection.GeneratedProtocolMessageType('GetRules', (_message.Message,), dict(
    ...
    ResPart = _reflection.GeneratedProtocolMessageType('ResPart', (_message.Message,), dict(
      ...
      __module__ = 'common.logic_pb2'
      # @@protoc_insertion_point(class_scope:grakn.protocol.LogicManager.GetRules.ResPart)
      ))
    ,
...
Explanation = _reflection.GeneratedProtocolMessageType('Explanation', (_message.Message,), dict(
  ...
  VarMappingEntry = _reflection.GeneratedProtocolMessageType('VarMappingEntry', (_message.Message,), dict(
    ...
    __module__ = 'common.logic_pb2'
    # @@protoc_insertion_point(class_scope:grakn.protocol.Explanation.VarMappingEntry)
    ))
  ,
  ...
  VarList = _reflection.GeneratedProtocolMessageType('VarList', (_message.Message,), dict(
    ...
    __module__ = 'common.logic_pb2'
    # @@protoc_insertion_point(class_scope:grakn.protocol.Explanation.VarList)
    ))
  ,
  DESCRIPTOR = _EXPLANATION,
  __module__ = 'common.logic_pb2'
  # @@protoc_insertion_point(class_scope:grakn.protocol.Explanation)
  ))
