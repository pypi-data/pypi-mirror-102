...
_COREDATABASEMANAGER_CONTAINS_REQ = _descriptor.Descriptor(
  name='Req',
  full_name='grakn.protocol.CoreDatabaseManager.Contains.Req',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='grakn.protocol.CoreDatabaseManager.Contains.Req.name', index=0,
...
_COREDATABASEMANAGER_CONTAINS_RES = _descriptor.Descriptor(
  name='Res',
  full_name='grakn.protocol.CoreDatabaseManager.Contains.Res',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='contains', full_name='grakn.protocol.CoreDatabaseManager.Contains.Res.contains', index=0,
...
_COREDATABASEMANAGER_CONTAINS = _descriptor.Descriptor(
  name='Contains',
  full_name='grakn.protocol.CoreDatabaseManager.Contains',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_COREDATABASEMANAGER_CREATE_REQ = _descriptor.Descriptor(
  name='Req',
  full_name='grakn.protocol.CoreDatabaseManager.Create.Req',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='grakn.protocol.CoreDatabaseManager.Create.Req.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_COREDATABASEMANAGER_CREATE_RES = _descriptor.Descriptor(
  name='Res',
  full_name='grakn.protocol.CoreDatabaseManager.Create.Res',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_COREDATABASEMANAGER_CREATE = _descriptor.Descriptor(
  name='Create',
  full_name='grakn.protocol.CoreDatabaseManager.Create',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_COREDATABASEMANAGER_ALL_REQ = _descriptor.Descriptor(
  name='Req',
  full_name='grakn.protocol.CoreDatabaseManager.All.Req',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_COREDATABASEMANAGER_ALL_RES = _descriptor.Descriptor(
  name='Res',
  full_name='grakn.protocol.CoreDatabaseManager.All.Res',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='names', full_name='grakn.protocol.CoreDatabaseManager.All.Res.names', index=0,
...
_COREDATABASEMANAGER_ALL = _descriptor.Descriptor(
  name='All',
  full_name='grakn.protocol.CoreDatabaseManager.All',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_COREDATABASEMANAGER = _descriptor.Descriptor(
  ...
  full_name='grakn.protocol.CoreDatabaseManager',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_COREDATABASE_SCHEMA_REQ = _descriptor.Descriptor(
  name='Req',
  full_name='grakn.protocol.CoreDatabase.Schema.Req',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='grakn.protocol.CoreDatabase.Schema.Req.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_COREDATABASE_SCHEMA_RES = _descriptor.Descriptor(
  name='Res',
  full_name='grakn.protocol.CoreDatabase.Schema.Res',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='schema', full_name='grakn.protocol.CoreDatabase.Schema.Res.schema', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_COREDATABASE_SCHEMA = _descriptor.Descriptor(
  name='Schema',
  full_name='grakn.protocol.CoreDatabase.Schema',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_COREDATABASE_DELETE_REQ = _descriptor.Descriptor(
  name='Req',
  full_name='grakn.protocol.CoreDatabase.Delete.Req',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='grakn.protocol.CoreDatabase.Delete.Req.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_COREDATABASE_DELETE_RES = _descriptor.Descriptor(
  name='Res',
  full_name='grakn.protocol.CoreDatabase.Delete.Res',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_COREDATABASE_DELETE = _descriptor.Descriptor(
  name='Delete',
  full_name='grakn.protocol.CoreDatabase.Delete',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_COREDATABASE = _descriptor.Descriptor(
  name='CoreDatabase',
  full_name='grakn.protocol.CoreDatabase',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
CoreDatabaseManager = _reflection.GeneratedProtocolMessageType('CoreDatabaseManager', (_message.Message,), dict(
  ...
  Contains = _reflection.GeneratedProtocolMessageType('Contains', (_message.Message,), dict(
    ...
    Req = _reflection.GeneratedProtocolMessageType('Req', (_message.Message,), dict(
      ...
      # @@protoc_insertion_point(class_scope:grakn.protocol.CoreDatabaseManager.Contains.Req)
      ))
    ,
    ...
    Res = _reflection.GeneratedProtocolMessageType('Res', (_message.Message,), dict(
      ...
      __module__ = 'core.core_database_pb2'
      # @@protoc_insertion_point(class_scope:grakn.protocol.CoreDatabaseManager.Contains.Res)
      ))
    ,
    DESCRIPTOR = _COREDATABASEMANAGER_CONTAINS,
    __module__ = 'core.core_database_pb2'
    # @@protoc_insertion_point(class_scope:grakn.protocol.CoreDatabaseManager.Contains)
    ))
  ,
  ...
  Create = _reflection.GeneratedProtocolMessageType('Create', (_message.Message,), dict(
    ...
    Req = _reflection.GeneratedProtocolMessageType('Req', (_message.Message,), dict(
      ...
      __module__ = 'core.core_database_pb2'
      # @@protoc_insertion_point(class_scope:grakn.protocol.CoreDatabaseManager.Create.Req)
      ))
    ,
    ...
    Res = _reflection.GeneratedProtocolMessageType('Res', (_message.Message,), dict(
      ...
      __module__ = 'core.core_database_pb2'
      # @@protoc_insertion_point(class_scope:grakn.protocol.CoreDatabaseManager.Create.Res)
      ))
    ,
    DESCRIPTOR = _COREDATABASEMANAGER_CREATE,
    __module__ = 'core.core_database_pb2'
    # @@protoc_insertion_point(class_scope:grakn.protocol.CoreDatabaseManager.Create)
    ))
  ,
  ...
  All = _reflection.GeneratedProtocolMessageType('All', (_message.Message,), dict(
    ...
    Req = _reflection.GeneratedProtocolMessageType('Req', (_message.Message,), dict(
      ...
      __module__ = 'core.core_database_pb2'
      # @@protoc_insertion_point(class_scope:grakn.protocol.CoreDatabaseManager.All.Req)
      ))
    ,
    ...
    Res = _reflection.GeneratedProtocolMessageType('Res', (_message.Message,), dict(
      ...
      __module__ = 'core.core_database_pb2'
      # @@protoc_insertion_point(class_scope:grakn.protocol.CoreDatabaseManager.All.Res)
      ))
    ,
    DESCRIPTOR = _COREDATABASEMANAGER_ALL,
    __module__ = 'core.core_database_pb2'
    # @@protoc_insertion_point(class_scope:grakn.protocol.CoreDatabaseManager.All)
    ))
  ,
  DESCRIPTOR = _COREDATABASEMANAGER,
  __module__ = 'core.core_database_pb2'
  # @@protoc_insertion_point(class_scope:grakn.protocol.CoreDatabaseManager)
  ))
...
CoreDatabase = _reflection.GeneratedProtocolMessageType('CoreDatabase', (_message.Message,), dict(
  ...
  Schema = _reflection.GeneratedProtocolMessageType('Schema', (_message.Message,), dict(
    ...
    Req = _reflection.GeneratedProtocolMessageType('Req', (_message.Message,), dict(
      ...
      __module__ = 'core.core_database_pb2'
      # @@protoc_insertion_point(class_scope:grakn.protocol.CoreDatabase.Schema.Req)
      ))
    ,
    ...
    Res = _reflection.GeneratedProtocolMessageType('Res', (_message.Message,), dict(
      ...
      __module__ = 'core.core_database_pb2'
      # @@protoc_insertion_point(class_scope:grakn.protocol.CoreDatabase.Schema.Res)
      ))
    ,
    DESCRIPTOR = _COREDATABASE_SCHEMA,
    __module__ = 'core.core_database_pb2'
    # @@protoc_insertion_point(class_scope:grakn.protocol.CoreDatabase.Schema)
    ))
  ,
  ...
  Delete = _reflection.GeneratedProtocolMessageType('Delete', (_message.Message,), dict(
    ...
    Req = _reflection.GeneratedProtocolMessageType('Req', (_message.Message,), dict(
      ...
      __module__ = 'core.core_database_pb2'
      # @@protoc_insertion_point(class_scope:grakn.protocol.CoreDatabase.Delete.Req)
      ))
    ,
    ...
    Res = _reflection.GeneratedProtocolMessageType('Res', (_message.Message,), dict(
      ...
      __module__ = 'core.core_database_pb2'
      # @@protoc_insertion_point(class_scope:grakn.protocol.CoreDatabase.Delete.Res)
      ))
    ,
    DESCRIPTOR = _COREDATABASE_DELETE,
    __module__ = 'core.core_database_pb2'
    # @@protoc_insertion_point(class_scope:grakn.protocol.CoreDatabase.Delete)
    ))
  ,
  DESCRIPTOR = _COREDATABASE,
  __module__ = 'core.core_database_pb2'
  # @@protoc_insertion_point(class_scope:grakn.protocol.CoreDatabase)
  ))
