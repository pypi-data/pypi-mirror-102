...
class StrategyBacktestStats(Model):
    ...
    @staticmethod
    def get_available_status_group_by_strategy(symbols=None, strategy_class_name=None) -> typing.Dict[typing.Tuple[str, str], list]:
        ...
        try:
            ...
            if strategy_class_name is not None:
                query = query.where(StrategyBacktestStats.stg_info == StrategyInfo.get(
