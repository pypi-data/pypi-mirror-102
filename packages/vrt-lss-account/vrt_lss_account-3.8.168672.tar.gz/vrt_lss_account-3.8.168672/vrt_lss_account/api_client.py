...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/3.8.168672/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.read_account_audit_data  # this is an instance of the class Endpoint
        api_instance.read_account_audit_data()  # this invokes api_instance.read_account_audit_data.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.read_account_audit_data.callable or self.callable in this class
