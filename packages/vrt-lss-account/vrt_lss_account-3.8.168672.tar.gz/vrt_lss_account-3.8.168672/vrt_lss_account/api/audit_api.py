...
class AuditApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __read_account_audit_data(
            ...
            **kwargs
            ...
            Keyword Args:
                ...
                service_name (ServiceName): [optional]
                method_name (MethodName): [optional]
        ...
        self.read_account_audit_data = _Endpoint(
            settings={
                'response_type': (UserAuditResult,),
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/account/audit',
                'operation_id': 'read_account_audit_data',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            callable=__read_account_audit_data
        )
