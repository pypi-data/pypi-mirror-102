...
Changes
-------------
1.2.1 Emoticons are unicode but Analytics raises an error on import. I am using the emoji library now in enhanced_report_client.data_upload to look for emojis and replace them.
so 'Ok to leave at front door 🙂' becomes 'to leave at front door :slightly_smiling_face:'
