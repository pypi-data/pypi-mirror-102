...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', '3.9.0-alpha.1618311141+d7ad78c3'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean 3.9.0-alpha.1618311141+d7ad78c3`
                """)
            else:
                raise
