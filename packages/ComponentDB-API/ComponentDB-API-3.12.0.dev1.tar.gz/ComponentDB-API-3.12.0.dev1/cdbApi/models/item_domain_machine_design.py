...
class ItemDomainMachineDesign(object):
    ...
    def __init__(self, id=None, name=None, item_identifier1=None, item_identifier2=None, qr_id=None, domain=None, derived_from_item=None, item_source_list=None, domain_id=None, primary_image_for_item=None, max_sort_order=None, item_category_list_import=None, description=None, entity_type_list=None, item_category_list=None, item_type_list=None, item_project_list=None, move_to_trash_error_msg=None, move_to_trash_warning_msg=None, current_hierarchy_item_element=None, alternate_name=None, assigned_item=None, status_property_type_name=None, move_to_trash_row_style=None, local_vars_configuration=None):  # noqa: E501
