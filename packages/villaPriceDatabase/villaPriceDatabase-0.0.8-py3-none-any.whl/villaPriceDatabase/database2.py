...
__all__ = ['DEFAULTCOLS', 'PandasDataFrameAttribute', 'Database', 'updateWithDfs', 'lambdaPresignUpload',
           'lambdaIngestUpload', 'lambdaSingleBranchQuery', 'lambdaAllBranchesQuery', 'refreshGz', 'getAllGz']
...
@ttl_cache(ttl=100)
def getAllGz(*args):
  url = S3.presign(key = 'allData.gz',bucket=PRICE_BUCKET_NAME)
