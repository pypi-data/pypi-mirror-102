...
__all__ = ['TstCallback', 'source_events', 'Src', 'SrcCallback', 'GymSrc', 'FirstLast', 'SourceDataset',
           'IterableTfmdLists', 'vstack_collate', 'fr_collate', 'IterableTfmdDL', 'IterableDataBlock', 'SourceBlock',
           'map_iters', 'noop_splitter', 'get_all_keys', 'SourceDataBlock']
...
class TstCallback(AgentCallback):
    ...
    def before_noise(self):
        ...
        self.agent.action=L([ifnone(self.constant,self.action_space.sample()) for _ in range(bs)])
...
class SourceBlock(TransformBlock):
    def __init__(self,source,dls_kwargs=None,**kwargs):
        ...
        super().__init__(dls_kwargs=dls_kwargs,**kwargs)
