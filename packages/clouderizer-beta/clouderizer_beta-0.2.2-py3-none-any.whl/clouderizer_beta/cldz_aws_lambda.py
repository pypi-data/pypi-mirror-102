...
def lambda_deploy_codebuild(base_dir,namespace,project_name,stackName, projectConfig, model_path,infra,pipPackages,userS3Bucket,preprocess_path=None,postprocess_path=None,predict_path=None,timeout=30):
