...
class Clouderizer(object):
	...
	def create(self,name,file_path=None,model_type=None,notebook_type=None,schema=None):
			...
			if type(servingproject)==dict and "id" in servingproject:
				...
				if uploadmodel_resp=="Success":
					...
					if type(servingmodel)==dict and "id" in servingmodel:
						...
						notebookAccessUrl = lambda_deploy_codebuild(LOCAL_DIR,"nb", projectName, projectName+"-stack", projectConfig, notebook_path,infra,pipPackages,userS3Bucket,timeout=15*60)
		...
		if execution_type=="model":
			...
			if type(servingproject)==dict and "id" in servingproject:		
				...
				if uploadmodel_resp=="Success":
					...
					modelAccessUrl = lambda_deploy_codebuild(LOCAL_DIR,"model", projectName, projectName+"-stack", projectConfig, model_path,infra,pipPackages,userS3Bucket,preprocess_path,postprocess_path,predict_path)
