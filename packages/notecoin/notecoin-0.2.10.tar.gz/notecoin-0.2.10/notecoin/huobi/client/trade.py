from notecoin.huobi.constant import (AccountType, OrderSide, OrderSource,
                                     OrderState, OrderType)
from notecoin.huobi.service.trade import (TradeService, TRadeServiceSocket,
                                          TRadeServiceSocketSub)
from notecoin.huobi.utils import (check_currency, check_list, check_range,
...
class TradeClient(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.trade_client = TradeService(*args, **kwargs)
        self.trade_client_socket = TRadeServiceSocket(*args, **kwargs)
        self.trade_client_socket_sub = TRadeServiceSocketSub(*args, **kwargs)
    ...
    def get_fee_rate(self, symbols: str) -> list:
        ...
        return self.trade_client.get_fee_rate_service(params)
    ...
    def get_transact_fee_rate(self, symbols: str) -> list:
        ...
        return self.trade_client.get_transact_fee_rate_service(params)
    ...
    def sub_order_update(self, symbols: str, callback, error_handler=None):
        ...
        self.trade_client_socket_sub.sub_order_update_v2_service(callback, error_handler, params)
    ...
    def req_order_list(self, symbol: str, account_id: int, callback, order_states: str,
        ...
        self.trade_client_socket.req_order_list_service(callback, error_handler, params)
    ...
    def req_order_detail(self, order_id: str, callback,
        ...
        self.trade_client_socket.req_order_detail_service(callback, error_handler, params)
    ...
    def get_order(self, order_id: 'int'):
        ...
        return self.trade_client.get_order_by_id_service(params)
    ...
    def get_order_by_client_order_id(self, client_order_id):
        ...
        return self.trade_client.get_order_by_client_order_id_service(params)
    ...
    def get_orders(self, symbol: str, order_state: OrderState, order_type: OrderType = None,
        ...
        return self.trade_client.get_orders_service(params)
    ...
    def get_open_orders(self, symbol: str, account_id: 'int', side: 'OrderSide' = None,
        ...
        return self.trade_client.get_open_orders_service(params)
    ...
    def get_history_orders(self, symbol=None, start_time=None, end_time=None, size=None, direct=None) -> list:
        ...
        return self.trade_client.get_history_orders_service(params)
    ...
    def get_match_result(self, symbol: str, order_type: OrderSide = None, start_date: str = None,
        ...
        return self.trade_client.get_match_results_service(params)
    ...
    def get_match_results_by_order_id(self, order_id: int) -> list:
        ...
        return self.trade_client.get_match_results_by_order_id_service(params)
    ...
    def create_order(self, symbol: str, account_id: 'int', order_type: 'OrderType', amount: 'float',
        ...
        return self.trade_client.post_create_order_service(params)
    ...
    def cancel_order(self, symbol, order_id):
        ...
        return self.trade_client.post_cancel_order_service(params)
    ...
    def cancel_orders(self, symbol, order_id_list):
        ...
        return self.trade_client.post_batch_cancel_order_service(params)
    ...
    def cancel_open_orders(self, account_id, symbols: str = None, side=None, size=None):
        ...
        return self.trade_client.post_batch_cancel_open_order_service(params)
    ...
    def cancel_client_order(self, client_order_id) -> int:
        ...
        return self.trade_client.post_cancel_client_order_service(params)
    ...
    def transfer_between_futures_and_pro(self, currency: str, amount: 'float',
        ...
        return self.trade_client.post_transfer_futures_pro_service(params)
    ...
    def batch_create_order(self, order_config_list) -> int:
        ...
        return self.trade_client.post_batch_create_order_service(new_config_list)
    ...
    def sub_trade_clearing(self, symbols: str, callback, error_handler=None):
        ...
        return self.trade_client_socket_sub.sub_trade_clearing_v2_service(callback, error_handler, params)
