...
from notecoin.huobi.model import Response
...
# if not need connect immediately, it will enter delay connect status and will connect after setting times
...
def call_sync(request, is_checked=False):
    if request.method == "GET":
        ...
        return Response(dict_data=dict_data)
