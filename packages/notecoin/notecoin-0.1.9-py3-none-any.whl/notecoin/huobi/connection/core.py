...
from .impl import (RestApiRequest, WebsocketManage, WebsocketRequest,
                   WebSocketWatchDog, call_sync, call_sync_perforence_test)
...
class RestApiSyncClient(object):
    ...
    def __init__(self, api_key=None, secret_key=None, url=None, *args, **kwargs):
        ...
        self.__server_url = url or WebSocketDefine.Uri
