...
from notecoin.huobi.model.market import (Candlestick, CandlestickEvent,
                                         ...
                                         MarketDetailEvent, MarketDetailMerged,
                                         MarketDetailReq, MbpFullEvent,
                                         MbpIncreaseEvent, MbpReq, PriceDepth,
                                         PriceDepthBbo, PriceDepthBboEvent,
                                         PriceDepthEvent, PriceDepthReq, Trade,
                                         TradeDetail, TradeDetailEvent,
                                         TradeDetailReq)
...
class MarketService(RestApiSyncClient):
    ...
    def get_market_tickers_service(self, params):
        ...
        def parse(dict_data):
            return dict_data.get("data", [])  # default_parse_list_dict(dict_data.get("data", []), MarketTicker)
