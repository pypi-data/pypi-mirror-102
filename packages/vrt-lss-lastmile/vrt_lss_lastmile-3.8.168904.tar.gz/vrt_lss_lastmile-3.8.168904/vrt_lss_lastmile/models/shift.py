...
class Shift(object):
    ...
    def __init__(self, key=None, shift_type=None, resource_key=None, availability_time=None, working_time=None, start_location_key=None, finish_location_key=None, max_locations=0, tariff=None, attributes=[], local_vars_configuration=None):  # noqa: E501
    ...
    def max_locations(self):
        ...
        Limit of the number of performer's locations in one trip.  # noqa: E501
