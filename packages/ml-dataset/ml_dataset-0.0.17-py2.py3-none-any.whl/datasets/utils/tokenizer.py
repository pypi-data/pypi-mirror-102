...
import re
import unicodedata
from datasets.utils.data_processor import padding_seq
...
class Tokenizer(object):
    ...
    def tokenize(self, text, maxlen=None):
        ...
        if maxlen is not None:
            ...
            tokens = padding_seq(tokens, maxlen)
...
class BertTokenizer(Tokenizer):
    ...
    def __init__(
        ...
        self._token_unk_id = self._vocab_size
    ...
    def encode(
        ...
        if maxlen is not None:
            ...
            first_tokens = padding_seq(first_tokens, maxlen)
            second_tokens = padding_seq(second_tokens, maxlen)
