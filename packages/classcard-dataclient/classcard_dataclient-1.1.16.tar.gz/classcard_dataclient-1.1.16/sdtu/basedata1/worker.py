    ...
    for cut_year in range(front_years):
        ...
        while True:
            ...
            for d in current_rows:
                ...
                current_number_list.append(section.number)
        ...
        current_number_list.append(current_yjs_section.number)
    ...
    for cut_year in range(front_years):
        ...
        while True:
            ...
            for d in current_rows:
                ...
                current_number_list.append(student.number)
...
def transact_teacher_data():
    ...
    while True:
        ...
        for d in current_rows:
            ...
            current_number_list.append(teacher.number)
...
def start_data_sync():
    ...
    current_section_num = transact_section_data()
    current_student_num = transact_student_data()
    current_teacher_num = transact_teacher_data()
