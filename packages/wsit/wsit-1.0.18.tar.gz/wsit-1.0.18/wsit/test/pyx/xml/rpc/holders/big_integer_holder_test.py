...
class TestBigIntegerHolder(unittest.TestCase):
    ...
    def test_to_string(self):
        for tested_value in TestBigIntegerHolder.valid_values:
            big_integer_holder = BigIntegerHolder(tested_value)
            self.assertTrue(str(tested_value).__eq__(big_integer_holder.__str__())) 
    ...
    def test_equals(self):
        ...
        self.assertTrue(big_integer_holder_1.__eq__(None) is False) 
        self.assertTrue(big_integer_holder_1.__eq__(int("123")) is False) 
        self.assertTrue(big_integer_holder_1.__eq__(big_integer_holder_1) is True) 
        self.assertTrue(big_integer_holder_1.__eq__(big_integer_holder_2) is True) 
        self.assertTrue(big_integer_holder_1.__eq__(big_integer_holder_3) is False) 
