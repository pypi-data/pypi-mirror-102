...
class TestUShortHolderEditor(unittest.TestCase):

    def test_init(self):
        ushort_holder_editor = UShortHolderEditor()
        self.assertTrue(ushort_holder_editor.get_value().get() == 0) 
    ...
    def test_set_value(self):
        ...
        for tested_value in TestUShortHolder.valid_values:
            ...
            self.assertTrue(ushort_holder.get() == ushort_holder_editor.get_value().get()) 
    ...
    def test_set_as_text(self):
        ...
        for tested_value in TestUShortHolder.valid_values:
            ...
            self.assertTrue(ushort_holder_editor.get_as_text().__eq__(tested_value.__str__())) 
