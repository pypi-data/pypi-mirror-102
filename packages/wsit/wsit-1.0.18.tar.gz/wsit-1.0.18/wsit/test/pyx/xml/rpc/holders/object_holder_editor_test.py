...
class TestObjectHolderEditor(unittest.TestCase):
    def test_init(self):
    ...
    def test_set_value(self):
        ...
        for tested_value in TestObjectHolder.valid_values:
            ...
            object_holder = object_holder_editor.get_value()
            self.assertTrue(tested_value == object_holder.get()) 
    ...
    def test_get_as_text(self):
        ...
        for tested_value in TestObjectHolder.valid_values:
            object_holder_editor.set_value(ObjectHolder(tested_value))
            self.assertTrue(tested_value.__str__().__eq__(object_holder_editor.get_as_text())) 
