...
class TestCharHolder(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertTrue(char_holder.get() == '\0') 
    ...
    def test_init_param(self):
        for tested_value in TestCharHolder.valid_values:
            ...
            self.assertTrue(char_holder.get() == tested_value) 
    ...
    def test_to_string(self):
        for tested_value in TestCharHolder.valid_values:
            ...
            self.assertTrue(str(tested_value).__eq__(char_holder.__str__())) 
    ...
    def test_equals(self):
        ...
        self.assertTrue(char_holder_1.__eq__(None) is False) 
        self.assertTrue(char_holder_1.__eq__(int("123")) is False) 
        self.assertTrue(char_holder_1.__eq__(char_holder_1) is True) 
        self.assertTrue(char_holder_1.__eq__(char_holder_2) is True) 
        self.assertTrue(char_holder_1.__eq__(char_holder_3) is False) 
