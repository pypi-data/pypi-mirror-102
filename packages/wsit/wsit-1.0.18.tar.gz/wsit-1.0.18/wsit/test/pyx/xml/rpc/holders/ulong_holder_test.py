...
class TestULongHolder(unittest.TestCase):
    ...
    def test_to_string(self):
        for tested_value in TestULongHolder.valid_values:
            ulong_holder = ULongHolder(tested_value)
            self.assertTrue(ulong_holder.__str__().__eq__(str(tested_value))) 

    def test_equals(self):
        ulong_holder_1 = ULongHolder()
        ulong_holder_2 = ULongHolder()
        self.assertTrue(ulong_holder_1.__eq__(None) is False) 
        self.assertTrue(ulong_holder_1.__eq__(int("123")) is False) 
        self.assertTrue(ulong_holder_1.__eq__(ulong_holder_1) is True) 
        self.assertTrue(ulong_holder_1.__eq__(ulong_holder_2) is True) 
        ulong_holder_2.set(123456789012345678)
        self.assertTrue(ulong_holder_1.__eq__(ulong_holder_2) is False) 
