...
class TestFloatHolderEditor(unittest.TestCase):
    ...
    def test_set_value(self):
        ...
        for tested_value in TestFloatHolder.valid_values:
            ...
            self.assertTrue(math.isclose(tested_value, float_holder_editor.get_value().get())) 
    ...
    def test_set_as_text(self):
        ...
        for tested_value in TestFloatHolder.valid_values:
            ...
            self.assertTrue(str(float(tested_value)).__eq__(float_holder_editor.get_as_text())) 
