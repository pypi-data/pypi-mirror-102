...
class TestStringHolderEditor(unittest.TestCase):

    def test_init(self):
        string_holder_editor = StringHolderEditor()
        self.assertTrue(string_holder_editor.get_value().get() is None) 
    ...
    def test_set_value(self):
        ...
        for tested_value in TestStringHolder.valid_values:
            ...
            self.assertTrue(string_holder_editor.get_value().get() == tested_value) 
    ...
    def test_set_as_text(self):
        ...
        for tested_value in TestStringHolder.valid_values:
            ...
            self.assertTrue(string_holder_editor.get_as_text().__eq__(tested_value)) 
