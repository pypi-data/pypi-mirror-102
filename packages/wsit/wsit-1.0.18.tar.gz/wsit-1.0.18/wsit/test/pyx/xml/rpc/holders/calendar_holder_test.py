...
class TestCalendarHolder(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertTrue(date_time == calendar_holder.get()) 
    ...
    def test_init_param(self):
        for tested_value in TestCalendarHolder.valid_values:
            ...
            self.assertTrue(tested_value == calendar_holder.get()) 
    ...
    def test_to_string(self):
        for tested_value in TestCalendarHolder.valid_values:
            calendar_holder = CalendarHolder(tested_value)
            self.assertTrue(tested_value.__eq__(calendar_holder.__str__())) 
    ...
    def test_equals(self):
        ...
        self.assertTrue(calendar_holder_1.__eq__(None) is False) 
        self.assertTrue(calendar_holder_1.__eq__(123) is False) 
        self.assertTrue(calendar_holder_1.__eq__(calendar_holder_1) is True) 
        self.assertTrue(calendar_holder_1.__eq__(calendar_holder_2) is True) 
        calendar_holder_2.set(date_time_2)
        self.assertTrue(calendar_holder_1.__eq__(calendar_holder_2) is False) 
