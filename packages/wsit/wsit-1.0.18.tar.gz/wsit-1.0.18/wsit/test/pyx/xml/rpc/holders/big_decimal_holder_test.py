...
class TestBigDecimalHolder(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertTrue(bd.__eq__(big_decimal_holder.get())) 
    ...
    def test_to_string(self):
        for tested_value in TestBigDecimalHolder.valid_values:
            dec_value = BigDecimal.init_from_str(tested_value)
            big_decimal_holder = BigDecimalHolder(dec_value)
            self.assertTrue(dec_value.__str__().__eq__(big_decimal_holder.__str__())) 
    ...
    def test_equals(self):
        ...
        self.assertTrue(big_decimal_holder_1.__eq__(None) is False) 
        self.assertTrue(big_decimal_holder_1.__eq__(int("123")) is False) 
        self.assertTrue(big_decimal_holder_1.__eq__(big_decimal_holder_1) is True) 
        self.assertTrue(big_decimal_holder_1.__eq__(big_decimal_holder_2) is True) 
        self.assertTrue(big_decimal_holder_1.__eq__(big_decimal_holder_3) is False) 
