...
class TestUByteHolder(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertTrue(ubyte_holder.get() == 0) 
    ...
    def test_init_param(self):
        for tested_value in TestUByteHolder.valid_values:
            ...
            self.assertTrue(ubyte_holder.get() == tested_value) 
    ...
    def test_to_string(self):
        for tested_value in TestUByteHolder.valid_values:
            ubyte_holder = UByteHolder(tested_value)
            self.assertTrue(ubyte_holder.__str__().__eq__(str(tested_value))) 
