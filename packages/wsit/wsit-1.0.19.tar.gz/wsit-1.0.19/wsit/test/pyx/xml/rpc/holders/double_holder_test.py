...
class TestDoubleHolder(unittest.TestCase):
    ...
    def test_init_param(self):
        for tested_value in TestDoubleHolder.valid_values:
            ...
            self.assertTrue(math.isclose(double_holder.get(), tested_value)) 
    ...
    def test_to_string(self):
        for tested_value in TestDoubleHolder.valid_values:
            double_holder = DoubleHolder(tested_value)
            self.assertTrue(double_holder.__str__().__eq__(float(tested_value).__str__())) 

    def test_equals(self):
        double_holder_1 = DoubleHolder()
        double_holder_2 = DoubleHolder()
        self.assertTrue(double_holder_1.__eq__(None) is False) 
        self.assertTrue(double_holder_1.__eq__(int("123")) is False) 
        self.assertTrue(double_holder_1.__eq__(double_holder_1) is True) 
        self.assertTrue(double_holder_1.__eq__(double_holder_2) is True) 
        double_holder_2.set(1234561213456.12)
        self.assertTrue(double_holder_1.__eq__(double_holder_2) is False) 
