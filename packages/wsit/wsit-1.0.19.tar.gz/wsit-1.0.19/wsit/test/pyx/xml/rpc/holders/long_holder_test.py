...
class TestLongHolder(unittest.TestCase):
    ...
    def test_to_string(self):
        for tested_value in TestLongHolder.valid_values:
            long_holder = LongHolder(tested_value)
            self.assertTrue(long_holder.__str__().__eq__(str(tested_value))) 

    def test_equals(self):
        long_holder_1 = LongHolder()
        long_holder_2 = LongHolder()
        self.assertTrue(long_holder_1.__eq__(None) is False) 
        self.assertTrue(long_holder_1.__eq__(int("123")) is False) 
        self.assertTrue(long_holder_1.__eq__(long_holder_1) is True) 
        self.assertTrue(long_holder_1.__eq__(long_holder_2) is True) 
        long_holder_2.set(123456789012345678)
        self.assertTrue(long_holder_1.__eq__(long_holder_2) is False) 
