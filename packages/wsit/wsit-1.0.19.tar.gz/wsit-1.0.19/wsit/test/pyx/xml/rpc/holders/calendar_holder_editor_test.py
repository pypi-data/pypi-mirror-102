...
class TestCalendarHolderEditor(unittest.TestCase):
    def test_init(self):
        calendar_holder_editor = CalendarHolderEditor()
        calendar_holder = CalendarHolder()
        self.assertTrue(calendar_holder.get() == calendar_holder_editor.get_value().get()) 
    ...
    def test_set_value(self):
        ...
        for tested_value in TestCalendarHolder.valid_values:
            ...
            self.assertTrue(calendar_holder == calendar_holder_editor.get_value()) 
    ...
    def test_set_as_text(self):
        ...
        for tested_value in TestCalendarHolder.valid_text_values:
            ...
            self.assertTrue(tested_value == calendar_holder_editor.get_as_text()) 
