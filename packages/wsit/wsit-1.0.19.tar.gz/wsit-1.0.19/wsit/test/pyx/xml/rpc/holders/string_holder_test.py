...
class TestStringHolder(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertTrue(string_holder.get() is None) 
    ...
    def test_init_param(self):
        for tested_value in TestStringHolder.valid_values:
            ...
            self.assertTrue(string_holder.get() == tested_value) 
    ...
    def test_to_string(self):
        for tested_value in TestStringHolder.valid_values:
            string_holder = StringHolder(tested_value)
            self.assertTrue(string_holder.__str__().__eq__(tested_value)) 

    def test_equals(self):
        string_holder_1 = StringHolder("FirstString")
        string_holder_2 = StringHolder("FirstString")
        self.assertTrue(string_holder_1.__eq__(None) is False) 
        self.assertTrue(string_holder_1.__eq__(int("123")) is False) 
        self.assertTrue(string_holder_1.__eq__(string_holder_1) is True) 
        self.assertTrue(string_holder_1.__eq__(string_holder_2) is True) 
        string_holder_2.set("AnotherString")
        self.assertTrue(string_holder_1.__eq__(string_holder_2) is False) 
