...
class TestShortHolder(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertTrue(short_holder.get() == 0) 
    ...
    def test_init_param(self):
        for tested_value in TestShortHolder.valid_values:
            ...
            self.assertTrue(short_holder.get() == tested_value) 
    ...
    def test_to_string(self):
        for tested_value in TestShortHolder.valid_values:
            short_holder = ShortHolder(tested_value)
            self.assertTrue(short_holder.__str__().__eq__(str(tested_value))) 

    def test_equals(self):
        short_holder_1 = ShortHolder()
        short_holder_2 = ShortHolder()
        self.assertTrue(short_holder_1.__eq__(None) is False) 
        self.assertTrue(short_holder_1.__eq__(int("123")) is False) 
        self.assertTrue(short_holder_1.__eq__(short_holder_1) is True) 
        self.assertTrue(short_holder_1.__eq__(short_holder_2) is True) 
        short_holder_2.set(12345)
        self.assertTrue(short_holder_1.__eq__(short_holder_2) is False) 
