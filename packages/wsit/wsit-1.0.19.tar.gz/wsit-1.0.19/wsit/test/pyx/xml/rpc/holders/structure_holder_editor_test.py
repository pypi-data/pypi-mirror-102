...
class TestStructureHolderEditor(unittest.TestCase):
    def test_init(self):
    ...
    def test_set_value(self):
        ...
        self.assertTrue(structure_holder_editor.get_value() == structure_holder) 
    ...
    def test_get_as_text(self):
        ...
        structure_holder_editor.set_value(structure_holder)
        self.assertTrue(structure_holder_editor.get_as_text().__eq__("None")) 
