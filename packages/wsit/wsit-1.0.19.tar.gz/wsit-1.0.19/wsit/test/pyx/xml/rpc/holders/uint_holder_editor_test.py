...
class TestUIntHolderEditor(unittest.TestCase):
    
    def test_init(self):
        uint_holder_editor = UIntHolderEditor()
        self.assertTrue(uint_holder_editor.get_value().get() == 0) 
    ...
    def test_set_value(self):
        ...
        for tested_value in TestUIntHolder.valid_values:
            ...
            self.assertTrue(int_holder.get() == uint_holder_editor.get_value().get()) 
    ...
    def test_set_as_text(self):
        ...
        for tested_value in TestUIntHolder.valid_values:
            ...
            self.assertTrue(uint_holder_editor.get_as_text().__eq__(tested_value.__str__())) 
