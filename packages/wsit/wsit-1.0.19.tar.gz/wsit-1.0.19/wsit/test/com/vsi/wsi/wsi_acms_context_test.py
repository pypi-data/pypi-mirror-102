...
class TestWsiAcmsContext(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertTrue(wsi_acms_context.get_sel_string() is None) 
        self.assertTrue(wsi_acms_context.get_ext_status() is None) 
        self.assertTrue(wsi_acms_context.get_app_name() is None) 
    ...
    def test_init_by_sel_str(self):
        for tested_value in TestWsiAcmsContext.valid_values:
            ...
            self.assertTrue(wsi_acms_context.get_sel_string() == tested_value) 
    ...
    def test_set_sel_string(self):
        for tested_value in TestWsiAcmsContext.valid_values:
            ...
            self.assertTrue(wsi_acms_context.get_sel_string().__eq__(tested_value)) 

    def test_set_ext_status(self):
        for tested_value in TestWsiAcmsContext.valid_values:
            wsi_acms_context = WsiAcmsContext()
            wsi_acms_context.set_ext_status(tested_value)
            self.assertTrue(wsi_acms_context.get_ext_status().__eq__(tested_value)) 

    def test_set_app_name(self):
        for tested_value in TestWsiAcmsContext.valid_values:
            wsi_acms_context = WsiAcmsContext()
            wsi_acms_context.set_app_name(tested_value)
            self.assertTrue(wsi_acms_context.get_app_name().__eq__(tested_value)) 
    ...
    def test_to_string(self):
        for tested_value in TestWsiAcmsContext.valid_text_values:
            ...
            wsi_acms_context.set_ext_status(tested_value)
            wsi_acms_context.set_app_name(tested_value)
            self.assertTrue(wsi_acms_context.__str__().__eq__(tested_value_to_string)) 
