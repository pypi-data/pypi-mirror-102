...
class TestWsiArray(unittest.TestCase):
    def test_init(self):
        wsi_array = WsiArray()
        self.assertTrue(wsi_array.get_value() is None) 

    def test_init_by_m_value(self):
        tested_value = "test"
        wsi_array = WsiArray.init_by_m_value(tested_value)
        self.assertTrue(wsi_array.get_value() == tested_value) 
    ...
    def test_init_by_all_vars(self):
        ...
        self.assertTrue(wsi_array.get_value() == m_value) 
        self.assertTrue(wsi_array.dim_ct == dim_ct) 
        self.assertTrue(wsi_array.dimensions == dimensions) 
    ...
    def test_export_array_by_wsi_buffer(self):
        ...
        self.assertTrue(wsi_array.msgb.__eq__(wsi_buffer)) 
