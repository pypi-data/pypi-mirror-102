...
class TestWsiDecimal(unittest.TestCase):
    def test_init(self):
        wsi_decimal = WsiDecimal()
        zero_big_decimal = BigDecimal.init_from_str("0.0")
        self.assertTrue(wsi_decimal.get_value().__str__().__eq__(zero_big_decimal.__str__())) 
        self.assertTrue(wsi_decimal.get_value() == zero_big_decimal) 
        self.assertTrue(wsi_decimal.get_precision() == 0) 
        self.assertTrue(wsi_decimal.get_scale() == 0) 
        self.assertTrue(wsi_decimal.get_decimal_type() == 0) 

    def test_init_2(self):
        tested_value = "-123456789.123456789"
        wsi_decimal = WsiDecimal(tested_value)
        self.assertTrue(str(wsi_decimal).__eq__(tested_value)) 

    def test_init_3(self):
        tested_value = BigDecimal.init_from_str("2.7182818284590452353602874713527")
        wsi_decimal = WsiDecimal(tested_value)
        self.assertTrue(wsi_decimal.__str__().__eq__(tested_value.__str__())) 
        self.assertTrue(wsi_decimal.get_value() == tested_value) 
    ...
    def test_init_4(self):
        ...
        self.assertTrue(wsi_decimal.__str__().__eq__(tested_value.__str__())) 
        self.assertTrue(wsi_decimal.get_value() == tested_value) 
        self.assertTrue(wsi_decimal.get_scale() == scale) 
        self.assertTrue(wsi_decimal.get_precision() == precision) 
        self.assertTrue(wsi_decimal.get_decimal_type() == dec_type) 
    ...
    def test_init_5(self):
        ...
        self.assertTrue(wsi_decimal.__str__().__eq__(wsi_decimal_other.__str__())) 
        self.assertTrue(wsi_decimal.get_value() == tested_value) 
        self.assertTrue(wsi_decimal.get_scale() == wsi_decimal_other.get_scale()) 
        self.assertTrue(wsi_decimal.get_precision() == wsi_decimal_other.get_precision()) 
        self.assertTrue(wsi_decimal.get_decimal_type() == wsi_decimal_other.get_decimal_type()) 
    ...
    def test_set_value_2(self):
        ...
        wsi_decimal = WsiDecimal()
        wsi_decimal.set_value(tested_value)
        self.assertTrue(wsi_decimal.__str__().__eq__(tested_value)) 
    ...
    def test_set_value_3(self):
        ...
        self.assertTrue(wsi_decimal_other.get_value() == tested_value) 
        self.assertTrue(wsi_decimal_other.__str__().__eq__(tested_value.__str__())) 
    ...
    def test_set_value_4(self):
        ...
        num123 = [49, 50, 51]
        self.assertTrue(wsi_decimal.set_value_from_buffer_offset(num123, 0) == tested_value) 

    def test_set_value_5(self):
        wsi_decimal = WsiDecimal()
        tested_value = BigDecimal.init_from_str("123")
        num123 = [49, 50, 51]
        self.assertTrue(wsi_decimal.set_value_from_buffer_offset_precision_scale_dec_type(num123, 0, 3, 0, WsiDecimal.DTYPE_NU) == tested_value) 

    def test_set_precision(self):
        tested_value = 5
        wsi_decimal = WsiDecimal()
        wsi_decimal.set_precision(tested_value)
        self.assertTrue(wsi_decimal.get_precision() == tested_value) 

    def test_set_scale(self):
        tested_value = 10
        wsi_decimal = WsiDecimal()
        wsi_decimal.set_scale(tested_value)
        self.assertTrue(wsi_decimal.get_scale() == tested_value) 

    def test_set_decimal_type(self):
        tested_value = WsiDecimal.DTYPE_NL
        wsi_decimal = WsiDecimal()
        wsi_decimal.set_decimal_type(tested_value)
        self.assertTrue(wsi_decimal.get_decimal_type() == tested_value) 
    ...
    def test_get_buffer_1(self):
        ...
        self.assertTrue(str_from_bytes.__eq__("123456789")) 
    ...
    def test_get_buffer_2(self):
        ...
        str_from_bytes = "".join(map(chr, ret_array))
        self.assertTrue(str_from_bytes.__eq__("012345678")) 
