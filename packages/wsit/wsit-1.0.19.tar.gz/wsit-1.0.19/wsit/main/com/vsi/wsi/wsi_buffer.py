 ...
 *  Atomic data types:
 ...
 """
    ...
    */
    ...
    def put_float_d_type(self, f_value: float, d_type: int):
    ...
    def put_float_d_type_new_pos(self, f_value: float, d_type: int, new_pos: int):
        self.set_position(new_pos)
    ...
    */
    ...
    def put_big_decimal_d_type_precision_scale_new_pos(self, obj: BigDecimal, d_type: int, new_pos: int, len: int,
                                                       scale: int):
        self.set_position(new_pos)
    ...
    def put_float_ary_d_type(self, ary: List[float], d_type: int):
    ...
    def put_float_ary_d_type_new_pos(self, ary: List[float], d_type: int, new_pos: int):
        self.set_position(new_pos)
    ...
    *****************************************************************/
    ...
    def get_float_d_type(self, d_type: int) -> float:
        WsiUtils.check_type(d_type, int)
        v = self.m_buffer[self.m_cur_pos] & 0x0ff
        self.m_cur_pos += 1
        v |= (self.m_buffer[self.m_cur_pos] & 0x0ff) << 8
    ...
    def get_float_d_type_new_pos(self, d_type: int, new_pos: int) -> float:
        self.set_position(new_pos)
...
//    }
    ...
    def get_big_decimal_d_type_precision_scale_new_pos(self, d_type: int, new_pos: int, precision: int,
    ...
    */
    ...
    def get_float_array(self, d_type: int, elems: int) -> List[float]:
        WsiUtils.check_type(elems, int)
        ret_ary = [float(0.0)] * elems
        for i in range(elems):
            ret_ary[i] = self.get_float_d_type(d_type)
        return ret_ary

    def get_float_array_new_pos(self, d_type: int, elems: int, new_pos: int) -> List[float]:
        self.set_position(new_pos)
