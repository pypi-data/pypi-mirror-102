...
# Form implementation generated from reading ui file 'client_part.ui'
#
...
class Ui_MainClientWindow(object):
    """Класс для построения основного окна ПОЛЬЗОВАТЕЛЯ со стороны клиентской части.
    ...
    def setupUi(self, MainClientWindow):
        ...
        MainClientWindow.resize(813, 580)
    ...
    def retranslateUi(self, MainClientWindow):
        ...
        MainClientWindow.setWindowTitle(_translate("MainClientWindow", "betta version"))
