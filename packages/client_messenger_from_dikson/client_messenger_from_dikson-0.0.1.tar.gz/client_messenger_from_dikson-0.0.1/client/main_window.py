...
class ClientMainWindow(QMainWindow):
    """Класс для визуализации основного окна клиентской части."""
    ...
    def history_list_update(self):
        """Метод для обработки истории переписки"""
    ...
    def select_active_user(self):
        """Метод для обработки события двойного клика по списку контактов"""
    ...
    def set_active_user(self):
        ...
        # Если ключ отсутствует, то ОШИБКА "не удалось начать чат с пользователем"
    ...
    def add_contact_window(self):
        """Метод для создания окна добавления контакта"""
    ...
    def add_contact_action(self, item):
        """Метод для обработки нажатия (клика) по кнопке ДОБАВИТЬ"""
    ...
    def add_contact(self, new_contact):
        """Метод, добавляющий контакт в серверную и клиентскую части"""
    ...
    def delete_contact_window(self):
        """Метод, создающий окно УДАЛЕНИЕ КОНТАКТА"""
    ...
    def delete_contact(self, item):
        """Метод, удаляющий контакт из серверной и клиентской частей"""
    ...
    def send_message(self):
        """Метод для шифрования и отправки сообщения"""

        # Если в поле ввода имеется текст, то забираем его и очищаем поле
    ...
    def message(self, message):
        """Метод для обработки, поступающих сообщений с их дешифровкой"""
    ...
    def connection_lost(self):
        """Метод для обработки потери соединения с сервером"""
    ...
    @pyqtSlot()
    def sig_205(self):
        """Метод обновления баз данных по команде сервера"""
    ...
    def make_connection(self, trans_obj):
        """Метод для соединение сигналов и слотов"""
