...
class ClientTransport(threading.Thread, QObject):
    """Класс для создания, инициализации сокета со стороны клиента.
    Подключение к базе данных, авторизация и проверка активного сервера,
    создание "приветственного сообщения" по протоколу JIM,
    получение ответа от сервера, создание и отправка сообщений пользователям по протоколу JIM"""
    ...
    def process_server_ans(self, message):
        """Метод получения и разбора ответного сообщения с сервера на ПРИВЕТСТВЕННОЕ СООБЩЕНИЕ"""
    ...
    def key_request(self, user):
        """Метод для запроса публичного ключа."""
