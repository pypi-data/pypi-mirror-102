...
['snapflow',
 ...
 'snapflow.templates.templates.function_template.{{ cookiecutter.function_name '
 '}}.tests',
 'snapflow.templates.templates.module_template.{{ cookiecutter.py_module_name '
 '}}',
 'snapflow.templates.templates.module_template.{{ cookiecutter.py_module_name '
 '}}.functions',
...
{'': ['*'],
 ...
 'snapflow.templates': ['templates/function_template/*',
...
['alembic>=1.5.5,<2.0.0',
 ...
 'common-model>=0.1.1,<0.2.0',
 'datacopy>=0.1.1,<0.2.0',
 'jinja2>=2.11.1,<3.0.0',
 'loguru>=0.5.1,<0.6.0',
 'networkx>=2.4,<3.0',
 'pandas>=1.0.1,<2.0.0',
