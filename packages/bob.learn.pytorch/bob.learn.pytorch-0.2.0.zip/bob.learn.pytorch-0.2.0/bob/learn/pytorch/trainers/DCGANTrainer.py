...
class DCGANTrainer(object):
  ...
  """
    ...
    def __init__(
        self, netG, netD, batch_size=64, noise_dim=100, use_gpu=False, verbosity_level=2
    ):
        """Init function
    ...
    """
        ...
        for epoch in range(n_epochs):
            for i, data in enumerate(dataloader, 0):
                ...
                output = self.netD(
                    fake.detach()
                )  # detach() -> done for speed, not correctness (PyTorch github's issue says so ...)
