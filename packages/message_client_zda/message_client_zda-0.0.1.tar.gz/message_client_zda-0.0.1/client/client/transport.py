...
from client_dist.client.common.variables import ACTION, PRESENCE, TIME, USER, \
    ACCOUNT_NAME, \
    PUBLIC_KEY, RESPONSE, ERROR, DATA, RESPONSE_511, SENDER, MESSAGE, \
    DESTINATION, MESSAGE_TEXT, GET_CONTACTS, LIST_INFO, USERS_REQUEST, \
    PUBLIC_KEY_REQUEST, ADD_CONTACT, REMOVE_CONTACT, EXIT
from server_dist.server.common.utils import ServerError, send_message, \
    get_message

CLIENT_LOG = logging.getLogger('client_CLIENT_LOG')
