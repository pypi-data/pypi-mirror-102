...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', '3.0.0-alpha.1618691390+f46dfd6a'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud 3.0.0-alpha.1618691390+f46dfd6a`
                """)
            else:
                raise
