...
load_data = np2.load("./idol_images_gray_128.npz", allow_pickle=True)
...
def train_model():
    ...
    result = net.train(
        x_train, t_train, x_test, t_test, batch_size=32, iters_num=20000, print_epoch=1, evaluate_limit=200,
