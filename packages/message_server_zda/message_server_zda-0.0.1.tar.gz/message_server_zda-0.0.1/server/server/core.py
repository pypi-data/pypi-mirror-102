...
from server_dist.server.common.variables import MAX_CONNECTIONS, DESTINATION, \
    SENDER, \
    RESPONSE_400, ERROR, DATA, ACTION, PUBLIC_KEY_REQUEST, ACCOUNT_NAME, \
    RESPONSE_511, LIST_INFO, RESPONSE_202, USERS_REQUEST, RESPONSE_200, USER, \
    REMOVE_CONTACT, ADD_CONTACT, GET_CONTACTS, EXIT, MESSAGE_TEXT, TIME, \
    MESSAGE, PRESENCE, RESPONSE, PUBLIC_KEY, RESPONSE_205
...
class MessageProcessor(threading.Thread):
    '''
    Основной класс сервера. Работает в качестве отдельного потока.
    '''
    port = Port()

    def __init__(self, listen_address, listen_port, database):
        """
        :param listen_address:  адрес
        :param listen_port:  порт
        :param database: БД
        """
    ...
    def remove_client(self, client):
        ...
        Поиск и удаление клиента из списков и базы:
        :param client: клиент
        """
        SERVER_LOG.info(
    ...
    def init_socket(self):
        """
        Метод для инициализации сокета.
        """
        SERVER_LOG.info(
    ...
    def process_client_message(self, message, client):
        """
        Метод для отбработки поступающих сообщений.
        :param message: словарь-сообщение
        :param client: клиент
        :return:
        """
    ...
    def autorize_user(self, message, sock):
        """
        Метод для авторизции пользователей.
        :param message: словарь-сообщение
        :param sock: сокет
        :return:
        """
