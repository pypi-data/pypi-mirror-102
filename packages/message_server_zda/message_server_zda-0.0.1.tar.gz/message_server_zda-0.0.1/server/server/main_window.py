...
class MainWindow(QMainWindow):
    ...
    def create_users_model(self):
        """
        Метод для заполнения таблицы активных пользователей.
        """
        list_users = self.database.active_users_list()
        my_list = QStandardItemModel()
        my_list.setHorizontalHeaderLabels(
        ...
        for row in list_users:
            ...
            my_list.appendRow([user, ip, port, time])
        self.active_clients_table.setModel(my_list)
    ...
    def server_config(self):
        """
        Метод для создания окна с настройками сервера.
        """
    ...
    def reg_user(self):
        """
        Метод для создания окна регистрации пользователя.
        """
        global reg_window
