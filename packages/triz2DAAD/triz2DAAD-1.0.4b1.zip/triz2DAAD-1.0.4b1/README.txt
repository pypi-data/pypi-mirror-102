...
Triz2DAAD versión 1.0.4b1 210420 (c) 2019-21 Pedro Fernández
...
Triz2DAAD version 1.0.4b1 210420 (c) 2019-21 Pedro Fernández
...
**NEW**: -dr option will create a DAAD Ready 0.3 compatible template. In this mode status line and -md options are disabled.
