...
class HandlerBase(logging.Handler):
    ...
    def _asctime(self, record: logging.LogRecord):
        r"""
    ...
    def _message(self, record: logging.LogRecord):
        r"""
    ...
    def _engine(self, record: logging.LogRecord, engine: str):
        r"""
        Méthode ajoutant au LogRecord l'attribut engine.
        """
        record.engine = engine

    def _extract_format(self, record: logging.LogRecord):
        r"""
...
class BaseArtimon(HandlerBase):
    ...
    def parser(self, record: logging.LogRecord):
        name = record.name
        format = self.format
