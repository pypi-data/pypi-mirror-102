...
install_cmd = subparsers.add_parser('install', help='Installs the provided packages to the soil instance.')
install_cmd.add_argument(
    '--recursive', '-r', default=False, action='store_true', help="Recursive. Use a txt file instead."
)
install_cmd.add_argument(
    'packages', nargs='+', metavar='PACKAGE[S]',
