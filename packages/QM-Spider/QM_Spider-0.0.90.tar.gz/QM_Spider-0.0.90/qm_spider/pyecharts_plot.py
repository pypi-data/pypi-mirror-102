...
class Line_Py(Pyecharts_Var):
    def __init__(self, title, x_value, y_name, y_value, *args, pos_top='bottom', legend_icon='roundRect'):
...
class Bar_Py(Pyecharts_Var):
    def __init__(self, title, x_value, y_name, y_value, reversal_axis=True, pos_top='bottom', legend_icon='roundRect'):
