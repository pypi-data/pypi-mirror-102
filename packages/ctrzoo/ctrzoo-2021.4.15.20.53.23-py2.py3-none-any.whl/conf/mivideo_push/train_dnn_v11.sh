...
config_path="conf/mivideo_push/dnn_v11.yml"

# 强行删除training flag
/home/work/inf/infra-client/bin/hdfs dfs -rm /user/h_data_platform/platform/push/mipush/data/mitvpush/v11_requirements/model/checkpoint_batch/_TRAIN*
