...
TDColumn = ndutls.namedtuple('TDColumn', ('column', 'subquery_index', 'conditions', 'alias'), defaults=((), None,))
TDSubquery = ndutls.namedtuple('TDSubquery', ('subquery', 'start', 'stop', 'write_subquery'))
