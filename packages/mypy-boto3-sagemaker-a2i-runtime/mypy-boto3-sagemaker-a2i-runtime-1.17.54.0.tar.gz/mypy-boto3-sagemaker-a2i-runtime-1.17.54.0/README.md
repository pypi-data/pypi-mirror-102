...
[boto3.AugmentedAIRuntime 1.17.54](https://boto3.amazonaws.com/v1/documentation/api/1.17.54/reference/services/sagemaker-a2i-runtime.html#AugmentedAIRuntime) service
compatible with
