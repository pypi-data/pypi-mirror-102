...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'wavefront', '1.0.0-alpha.1618782459+7c05346d'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource wavefront 1.0.0-alpha.1618782459+7c05346d`
                """)
            else:
                raise
