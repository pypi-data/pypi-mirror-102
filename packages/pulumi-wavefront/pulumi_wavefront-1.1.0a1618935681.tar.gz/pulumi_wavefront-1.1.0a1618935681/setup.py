...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'wavefront', '1.1.0-alpha.1618935681+ff492bcb'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource wavefront 1.1.0-alpha.1618935681+ff492bcb`
                """)
            else:
                raise
