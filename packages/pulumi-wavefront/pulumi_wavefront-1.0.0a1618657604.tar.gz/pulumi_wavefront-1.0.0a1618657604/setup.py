...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'wavefront', '1.0.0-alpha.1618657604+f0692030'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource wavefront 1.0.0-alpha.1618657604+f0692030`
                """)
            else:
                raise
