...
# @Last Modified time: 2021-04-13 17:27:42
...
class LocalServer(object):
	...
	def cpFilePreprocess(self,alreadyRecord,countNum=None):
		...
		command = "cp {jacocoIt} {mergeFile}/{index}.exec".format(jacocoIt=self.jacocoIt.format(
				week=self.alreadyRecord.week_num,service_name=self.alreadyRecord.service_name,recordID=self.alreadyRecord.id,index=countNum),mergeFile=mergeFile,
