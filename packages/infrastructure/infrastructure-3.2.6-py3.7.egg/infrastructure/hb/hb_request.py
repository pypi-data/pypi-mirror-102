...
# @Last Modified time: 2021-04-13 15:19:01
import os
...
class HBRequest(object):
	...
	def getServiceLevel(self,service_name,helloBikeToken,
		...
		if response['status']:
			...
			return infos.get('data',{}).get('level',0)
		else:
			return 0
...
if __name__ == '__main__':
	...
	# 	isServer=False)
	# print(a)
	print(hb.getServiceLevel("AppHelloHitchAdminService","","",isServer=False))
	# print(len(a))
