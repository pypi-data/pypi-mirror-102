...
from mmcc_framework import Framework, NoNluAdapter, validate_process, validate_callbacks
...
class Application(tk.Frame):
    def __init__(self, master=None):
        ...
        errors = validate_process(self.framework._process) + validate_callbacks(self.framework._process, get_callback)
        if errors:
            print(errors)
            exit()
