...
statusBytesInfo = {
    ...
    'c': "Invalid operand – occurs when and invalid parameter is given with a command.",
...
def executeCommand(pump, command, waitForPump=False):
    #pump.checkValidity()
    return sendCommand(pump.asciiAddress, command, waitForPump)
'''
