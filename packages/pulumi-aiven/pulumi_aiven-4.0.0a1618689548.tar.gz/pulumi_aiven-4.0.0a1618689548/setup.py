...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'aiven', '4.0.0-alpha.1618689548+1d1beef9'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource aiven 4.0.0-alpha.1618689548+1d1beef9`
                """)
            else:
                raise
