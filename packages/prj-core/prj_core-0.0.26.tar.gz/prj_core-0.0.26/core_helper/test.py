...
ID_P_T, X_t , y = get_df_procesado(2019,'DESERCION_2019_2020',"3-5 prim",[6,7,8],"lima",True)
...
export_resultado_final_nacional = hcm.export_resultado_final_nacional(alto=0.75,medio=0.5,path=PATH_RESULT)
