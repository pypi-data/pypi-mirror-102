...
class EntityFilterBasedOnIntent(Component):
    ...
    def process(self, message: Message, **kwargs: Any) -> None:
        ...
        if intent in update_dict:
            ...
            for e in entities:
                if e['entity'] in update_dict[intent]:
                    result.append(e)
...
class EntityChangeBasedOnIntent(Component):
    ...
    def process(self, message: Message, **kwargs: Any) -> None:
        ...
        if intent in update_dict:
            for e in entities:
                if e['entity'] in update_dict[intent]:
                    e['entity'] = update_dict[intent][e['entity']]
...
class IntentChangeBasedOnEntity(Component):
    ...
    def process(self, message: Message, **kwargs: Any) -> None:
        ...
        if intent in update_dict:
            ...
            if entity_name_set and not (set(update_dict[intent][0]) - entity_name_set) :
                intent['name'] = update_dict[intent][1]
