...
class IEthereumClient:
    ...
    async def transfer(self, asset, amount, recipient, gas_limit=1000000, gas_price=None, contracat_address=None):
        pass
...
class Client(interface.IXChainClient, IEthereumClient):
    ...
    async def transfer(self, asset, amount, recipient, gas_limit=1000000, gas_price=None, contract_address=None):
