...
from .sximage import open_fpga, close_fpga, call_fpga, read_fpga, stop_fpga
...
def fpgacap():
    ...
    if args.rgb or args.gray or args.heat or args.wav:
        if not args.width:
            print('The width option must be present with --rgb, --gray, --heat or --wav')
            sys.exit(1)
    elif args.loop:
        if not args.width:
