...
class ClassificationMeasures(BaseMeasures):
    ...
    def __init__(self, data: pd.DataFrame, ccp_alpha=None, labels_col=None):
        ...
        dtc = tree.DecisionTreeClassifier(min_samples_split=2, criterion='gini', random_state=0)
        ...
        self.dtc_pruned = tree.DecisionTreeClassifier(criterion='gini', ccp_alpha=ccp_alpha, random_state=0)
