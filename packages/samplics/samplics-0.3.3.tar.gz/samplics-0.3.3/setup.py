...
package_data = \
{'': ['*'],
 'samplics.datasets': ['data/birth.csv',
                       'data/birth.csv',
                       'data/birth.csv',
                       'data/birth.csv',
                       'data/birth.csv',
                       ...
                       'data/countycropareas.csv',
                       'data/countycropareas.csv',
                       'data/countycropareas_means.csv',
                       'data/countycropareas_means.csv',
                       'data/countycropareas_means.csv',
                       'data/countycropareas_means.csv',
                       'data/countycropareas_means.csv',
