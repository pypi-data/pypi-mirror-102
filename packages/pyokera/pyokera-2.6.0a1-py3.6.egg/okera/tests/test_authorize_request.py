...
limit 10'''
    ...
    def test_rewrite_in_set(self):
        ...
        with common.get_planner(ctx) as conn:
            ...
            conn.execute_ddl("""
                ...
                WHERE (in_set('ALL', NULL) OR in_set(string_col, user_attribute('does_not_exist')) OR in_set(string_col, user_attribute('whoami')))
            ...
            assert "WHERE (NULL OR string_col IN ('testuser'))" in result_sql
    ...
    def test_rewrite_hive_privacy(self):
        ...
        with common.get_planner(ctx) as conn:
            ...
            for fn in ["mask_ccn", "mask", "null", "sha2", "tokenize", "zero"]:
                conn.execute_ddl(
