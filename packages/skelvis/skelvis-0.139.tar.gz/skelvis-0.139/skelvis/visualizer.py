...
class SkeletonVisualizer:
    ...
    def __create_color_changer_tab(self, skeletons: List[DrawableSkeleton]) -> VBox:
        left_color_picker: ColorPicker = ColorPicker(
            description='Left color:', value=self.__get_default_left_color(skeletons))
        right_color_picker: ColorPicker = ColorPicker(
            description='Right color:', value=self.__get_default_right_color(skeletons))
        center_color_picker: ColorPicker = ColorPicker(
            description='Center color:', value=self.__get_default_center_color(skeletons))
