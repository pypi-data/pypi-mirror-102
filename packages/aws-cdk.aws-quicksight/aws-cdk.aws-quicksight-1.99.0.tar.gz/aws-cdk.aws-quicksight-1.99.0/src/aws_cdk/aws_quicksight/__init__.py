...
class CfnAnalysis(
    ...
    def __init__(
        ...
        *,
        ...
        errors: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.Sequence[typing.Union["CfnAnalysis.AnalysisErrorProperty", aws_cdk.core.IResolvable]]]] = None,
