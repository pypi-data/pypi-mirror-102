...
class Definition(LogReporter):
    def __init__(self, universe, fields, parameters=None, field_name=None, closure=None, session=None):
    ...
    def get_data(self, session=None, on_response=None):
        ...
        response = fundamental_class._get_data(universe=self.universe,
                                      fields=self.fields,
    ...
    async def get_data_async(self, session=None, on_response=None):
        fundamental_class = Fundamental(session=session, on_response=on_response)
        response = await fundamental_class._get_data_async(universe=self.universe,
                                                         fields=self.fields,
                                                         parameters=self.parameters,
                                                         field_name=self.field_name,
                                                         closure=self.closure)
