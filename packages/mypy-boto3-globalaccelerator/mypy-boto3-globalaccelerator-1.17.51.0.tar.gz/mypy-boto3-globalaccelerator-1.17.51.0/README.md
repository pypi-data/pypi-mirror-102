...
[boto3.GlobalAccelerator 1.17.51](https://boto3.amazonaws.com/v1/documentation/api/1.17.51/reference/services/globalaccelerator.html#GlobalAccelerator) service
compatible with
