...
from magic.log import LOG_INFO
import torch
...
class TorchEstimator(Estimator):
    ...
    def __init__(self, model, pre_trained, inputs_size,
                 ...
                 loss_avg_step=10, cudnn_benchmark=True, resume=True):
        """
        ...
        self.load(strict=False, resume=resume)
    ...
    def run_steps(self, epoch, steps_per_epoch, train_loader, optimizer, loss_fn):
        ...
        for i, sample in enumerate(train_loader, 0):
            ...
            if i % self.loss_avg_step == self.loss_avg_step - 1:
                ...
                LOG_INFO("epoch:{} step:{}/{} remain:{:.0f}s {} lr:{:.8f}".format(
        ...
        LOG_INFO("epoch_loss_mean:", self.epoch_loss_mean)
