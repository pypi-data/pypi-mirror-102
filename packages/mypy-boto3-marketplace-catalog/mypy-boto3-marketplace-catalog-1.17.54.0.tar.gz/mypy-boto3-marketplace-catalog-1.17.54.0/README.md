...
[boto3.MarketplaceCatalog 1.17.54](https://boto3.amazonaws.com/v1/documentation/api/1.17.54/reference/services/marketplace-catalog.html#MarketplaceCatalog) service
compatible with
