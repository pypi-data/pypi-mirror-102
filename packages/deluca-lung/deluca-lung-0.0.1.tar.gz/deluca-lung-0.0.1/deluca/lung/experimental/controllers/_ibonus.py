...
class IBonusCubic(Controller):
    '''
    Trainable I controller with cubic bonus function of time for trainable parameters A,B
    '''
...
class IBonus(Controller):
    '''
    Trainable I controller with bonus of the form A t^{-B} for trainable parameters A,B
    '''
