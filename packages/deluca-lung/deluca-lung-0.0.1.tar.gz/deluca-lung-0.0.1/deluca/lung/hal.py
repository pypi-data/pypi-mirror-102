""" Module for interacting with physical and/or simulated devices installed on the deluca.lunglator.
...
class Hal:
    """Hardware Abstraction Layer for deluca.lunglator hardware.
    Defines a common API for interacting with the sensors & actuators on the deluca.lunglator. The types of devices installed
    on the deluca.lunglator (real or simulated) are specified in a configuration file.
    """
    ...
    def __init__(self, config_file=default_hal_config):
        ...
        Args:
            config_file (str): Path to the configuration file containing the definitions of specific components on the
                deluca.lunglator machine. (e.g., config_file = "vent/io/config/devices.ini")
        """
