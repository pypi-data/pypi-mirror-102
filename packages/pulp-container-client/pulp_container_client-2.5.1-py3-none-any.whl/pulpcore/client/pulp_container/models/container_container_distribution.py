...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, repository_version=None, pulp_labels=None, content_guard=None, name=None, repository=None, base_path=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
