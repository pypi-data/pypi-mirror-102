...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, repository_version=None, pulp_created=None, pulp_labels=None, content_guard=None, pulp_href=None, name=None, repository=None, base_path=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
