...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, base_path=None, name=None, content_guard=None, repository_version=None, pulp_labels=None, repository=None, pulp_href=None, pulp_created=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
