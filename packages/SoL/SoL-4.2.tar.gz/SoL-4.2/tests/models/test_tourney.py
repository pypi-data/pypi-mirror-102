...
def test_corona_all_against_all(session, tourney_corona_all_against_all):
    ...
    cturn = tourney_corona_all_against_all.currentturn
    assert cturn == 1
    ...
    assert tourney_corona_all_against_all.rankedturn == 1
    ...
    tourney_corona_all_against_all.updateRanking()
    assert tourney_corona_all_against_all.rankedturn == 2
    cturn = tourney_corona_all_against_all.currentturn
    assert cturn == 3
