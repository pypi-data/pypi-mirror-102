...
class Tourney(GloballyUnique, Base):
    ...
    def makeNextTurn(self):
        ...
        if not (self.couplings == 'all' and self.championship.trainingboards):
        ...
        elif self.couplings == 'all' and self.championship.trainingboards:
            self._makeAllTurns()
            self.currentturn = 1
    ...
    def _makeAllTurns(self):
        ...
        while True:
            try:
                self._makeNextTurn()
            except NoMoreCombinationsError:
                break
