...
class MainWindow(QMainWindow):
    """Класс визуализации основного окна серверной части.
    Определение параметров элементов окна"""
    ...
    def __init__(self, database, server, config):
        ...
        self.setWindowTitle('Server part. Betta version (Dikson)')

        # Надпись о том, что ниже список подключённых клиентов
        self.label = QLabel('Список подключённых клиентов:', self)
        self.label.setFixedSize(300, 15)
        self.label.move(10, 70)

        # Окно со списком подключённых клиентов.
        self.active_clients_table = QTableView(self)
        self.active_clients_table.move(10, 90)
        self.active_clients_table.setFixedSize(780, 460)
