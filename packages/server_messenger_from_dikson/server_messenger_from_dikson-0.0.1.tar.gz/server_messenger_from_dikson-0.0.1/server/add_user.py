...
class RegisterUser(QDialog):
    """Класс для построения диалогового окна РЕГИСТРАЦИЯ ПОЛЬЗОВАТЕЛЯ со стороны серверной части.
    ...
    def __init__(self, database, server):
        ...
        self.label_username.setFixedSize(280, 15)

        self.client_name = QLineEdit(self)
        self.client_name.setFixedSize(280, 20)
        self.client_name.move(10, 30)

        self.label_passwd = QLabel('Введите пароль:', self)
        self.label_passwd.move(10, 55)
        self.label_passwd.setFixedSize(280, 15)

        self.client_passwd = QLineEdit(self)
        self.client_passwd.setFixedSize(280, 20)
        self.client_passwd.move(10, 75)
        self.client_passwd.setEchoMode(QLineEdit.Password)
        self.label_conf = QLabel('Введите подтверждение:', self)
        self.label_conf.move(10, 100)
        self.label_conf.setFixedSize(280, 15)

        self.client_conf = QLineEdit(self)
        self.client_conf.setFixedSize(280, 20)
