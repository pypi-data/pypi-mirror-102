...
class ServerStorage:
    ...
    class AllUsers:
        """Класс, создающий модель таблицы для всех пользователей"""
    ...
    class ActiveUsers:
        """Класс, создающий модель таблицы для активных пользователей"""
    ...
    class LoginHistory:
        """Класс, создающий модель таблицы истории входов"""
    ...
    class UsersContacts:
        """Класс, создающий модель таблицы для контактов пользователей"""
    ...
    class UsersHistory:
        """Класс, создающий модель таблицы истории действий"""
    ...
    def check_user(self, name):
        """Метод, проверяющий существование пользователя в БД."""
...
if __name__ == '__main__':
    ...
    test_db.user_login('test1', '192.168.1.113', 8080, 4)
    test_db.user_login('test2', '192.168.1.113', 8081, 5)
