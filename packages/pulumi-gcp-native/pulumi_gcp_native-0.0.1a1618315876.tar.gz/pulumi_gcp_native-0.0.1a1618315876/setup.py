...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp-native', '0.0.1a1618315876'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp-native 0.0.1a1618315876`
                """)
            else:
                raise
