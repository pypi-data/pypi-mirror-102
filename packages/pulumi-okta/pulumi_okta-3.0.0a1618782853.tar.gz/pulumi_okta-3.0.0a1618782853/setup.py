...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', '3.0.0-alpha.1618782853+063583db'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta 3.0.0-alpha.1618782853+063583db`
                """)
            else:
                raise
