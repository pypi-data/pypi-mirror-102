...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', '3.0.0-alpha.1618744991+c0939c43'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta 3.0.0-alpha.1618744991+c0939c43`
                """)
            else:
                raise
