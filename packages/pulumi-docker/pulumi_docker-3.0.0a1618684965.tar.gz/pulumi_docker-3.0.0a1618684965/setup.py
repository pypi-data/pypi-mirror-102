...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', '3.0.0-alpha.1618684965+8d68bed3'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker 3.0.0-alpha.1618684965+8d68bed3`
                """)
            else:
                raise
