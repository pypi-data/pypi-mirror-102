...
[boto3.CodeGuruReviewer 1.17.54](https://boto3.amazonaws.com/v1/documentation/api/1.17.54/reference/services/codeguru-reviewer.html#CodeGuruReviewer) service
compatible with
