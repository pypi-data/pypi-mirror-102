...
class FaceChecker:
    ...
    def checkLipstick(self,profile_image, check_image):
        ...
        for i in range(4):
            ...
            dict_simmetry_bottom[part]=image_work.get_parts_symmetry(opposed_part[0], opposed_part[1],2,15)
        ...
        for i in range(3):
            ...
            dict_simmetry_top[part]=image_work.get_parts_symmetry(opposed_part[0], opposed_part[1],2,15)
        return upperJsonInside, lowerJsonInside, upperJsonOutside, lowerJsonOutside, dict_simmetry_top, dict_simmetry_bottom, image_work.apply_errors_on_image(check_image,errors)
