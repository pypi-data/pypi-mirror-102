...
class FaceChecker:
    ...
    def checkInside(self,profile_file,check_image):
        ...
        if have_to_remove_shadow2(profile_file,profil_request_res):
        ...
        if have_to_remove_shadow2(check_image,check_request_res):
    ...
    def checkLipstick(self,profile_image, check_image):
        ...
        return upperJsonInside, lowerJsonInside, upperJsonOutside, lowerJsonOutside, image_work.apply_errors_on_image(check_image,errors)
