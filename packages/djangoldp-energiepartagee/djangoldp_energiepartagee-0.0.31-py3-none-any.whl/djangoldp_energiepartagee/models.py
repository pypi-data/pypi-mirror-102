...
class Actor (Model):
    ...
    iban = models.CharField(max_length=35, blank=True, null=True, verbose_name="IBAN")
    lat = models.DecimalField(max_digits=50, decimal_places=12, blank=True, null=True, verbose_name="Lattitude")
    lng = models.DecimalField(max_digits=50, decimal_places=12, blank=True, null=True, verbose_name="Longitude")
