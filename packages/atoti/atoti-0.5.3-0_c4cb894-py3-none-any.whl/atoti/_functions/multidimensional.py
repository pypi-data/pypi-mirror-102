...
def parent_value(
    ...
    *,
    ...
    Example:
        ...
        Considering a non slicing hierarchy :guilabel:`Date` with three levels :guilabel:`Year`, :guilabel:`Month`, and :guilabel:`Day`:
        ...
        Considering a slicing hierarchy :guilabel:`Date` with three levels :guilabel:`Year`, :guilabel:`Month`, and :guilabel:`Day`:
...
def total(measure: Measure, *hierarchies: Hierarchy) -> Measure:
    ...
    Example:
        Considering a hierarchy :guilabel:`Date` with three levels :guilabel:`Year`, :guilabel:`Month`, and :guilabel:`Day`.
        In the first case :guilabel:`Date` is not slicing.
        In the second case :guilabel:`Date` is slicing.
