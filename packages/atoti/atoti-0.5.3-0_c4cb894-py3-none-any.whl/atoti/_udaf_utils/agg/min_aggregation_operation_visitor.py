...
class MinAggregationOperationVisitor(AggregationOperationVisitor):
    ...
    def _get_contribute_source_code(
        self, operation_element: JavaOperationElement
    ) -> str:
        numeric_code = (
            self._get_numeric_code(operation_element)
    ...
    def _get_merge_source_code(self, operation_element: JavaOperationElement) -> str:
        if is_numeric_type(operation_element.output_type):
            output_type = operation_element.output_type
