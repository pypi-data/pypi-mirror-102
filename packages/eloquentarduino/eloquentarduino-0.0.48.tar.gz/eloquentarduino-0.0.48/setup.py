...
data = ["templates/on_device/sklearn/ResourcesBaseline.jinja", "templates/on_device/sklearn/Resources.jinja", "templates/on_device/sklearn/_Resources.jinja", "templates/on_device/sklearn/InferenceTime.jinja", "templates/on_device/tensorflow/ResourcesBaseline.jinja", "templates/on_device/tensorflow/Resources.jinja", "templates/on_device/tensorflow/_Resources.jinja", "templates/on_device/tensorflow/InferenceTime.jinja", "templates/metrics/Runtime.bck.jinja", "templates/metrics/Resources.jinja", "templates/metrics/Runtime.jinja", "templates/metrics/Empty.jinja", "templates/metrics/Baseline.jinja", "templates/Pipeline/PrincipalFFT.jinja", "templates/magics/eloquent-arduino.h.jinja", "templates/third_party/snoopy/snoopy.jinja", "templates/ml/classification/tensorflow/NeuralNetwork.jinja", "templates/ml/data/preprocessing/pipeline/PolynomialFeatures.jinja", "templates/ml/data/preprocessing/pipeline/StandardScaler.jinja", "templates/ml/data/preprocessing/pipeline/BoxCox.jinja", "templates/ml/data/preprocessing/pipeline/TSFRESH_@only.jinja", "templates/ml/data/preprocessing/pipeline/RateLimit.jinja", "templates/ml/data/preprocessing/pipeline/RFE.jinja", "templates/ml/data/preprocessing/pipeline/MinMaxScaler.jinja", "templates/ml/data/preprocessing/pipeline/Window.jinja", "templates/ml/data/preprocessing/pipeline/Pipeline.jinja", "templates/ml/data/preprocessing/pipeline/AbstractStep.jinja", "templates/ml/data/preprocessing/pipeline/FFT.jinja", "templates/ml/data/preprocessing/pipeline/TSFRESH.jinja", "templates/ml/data/preprocessing/pipeline/TSFRESH_if.jinja", "templates/ml/data/preprocessing/pipeline/StatMoments.jinja", "templates/ml/data/preprocessing/pipeline/Diff.jinja", "templates/ml/data/preprocessing/pipeline/YeoJohnson.jinja", "templates/ml/data/preprocessing/pipeline/Norm.jinja", "templates/ml/data/preprocessing/pipeline/SelectKBest.jinja", "templates/ml/data/preprocessing/pipeline/templates/Namespace.jinja", "templates/ml/data/preprocessing/pipeline/templates/Step.jinja", "templates/benchmarks/Baseline.jinja", "templates/benchmarks/sklearn/Resources.jinja", "templates/benchmarks/sklearn/Runtime.jinja", "templates/benchmarks/tf/Resources.jinja", "templates/benchmarks/tf/Runtime.jinja"]
...
setup(
  ...
  download_url = 'https://github.com/eloquentarduino/eloquentarduino-python/blob/master/dist/eloquentarduino-0.0.48.tar.gz?raw=true',
  keywords = [
    'ML',
    'Jupyter',
    'microcontrollers',
