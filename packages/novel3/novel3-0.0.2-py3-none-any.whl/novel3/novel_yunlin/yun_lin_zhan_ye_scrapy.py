...
class YuLinZhanYeScrapy(object):
    ...
    @classmethod
    def set_mysql_config(cls, ip=None, user_name=None, password=None, database=None):
    ...
    def visit_book_detail(self, book_list):
        for book in book_list:
            ...
            insert = "insert into book values(NULL,'%s','%s','%s',%d,%d,'%s','%s','%s',%d,0);" % (
                book['book_name'], book['author'], type, int(book['word_numbers']), int(pupular), book['update_date'],
