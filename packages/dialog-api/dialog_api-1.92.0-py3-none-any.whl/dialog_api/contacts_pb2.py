...
_RESPONSEGETCONTACTS_USERSBYPHONEENTRY = _descriptor.Descriptor(
  name='UsersByPhoneEntry',
  full_name='dialog.ResponseGetContacts.UsersByPhoneEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='dialog.ResponseGetContacts.UsersByPhoneEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='dialog.ResponseGetContacts.UsersByPhoneEntry.value', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_RESPONSEGETCONTACTS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='users_by_phone', full_name='dialog.ResponseGetContacts.users_by_phone', index=2,
      number=4, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_RESPONSEGETCONTACTS_USERSBYPHONEENTRY, ],
  enum_types=[
  ],
  serialized_options=b'\342?\032\n\030im.dlg.grpc.GrpcResponse',
  is_extendable=False,
...
_RESPONSEGETCONTACTS_USERSBYPHONEENTRY.containing_type = _RESPONSEGETCONTACTS
_RESPONSEGETCONTACTS.fields_by_name['user_peers'].message_type = peers__pb2._USEROUTPEER
_RESPONSEGETCONTACTS.fields_by_name['users_by_phone'].message_type = _RESPONSEGETCONTACTS_USERSBYPHONEENTRY
...
ResponseGetContacts = _reflection.GeneratedProtocolMessageType('ResponseGetContacts', (_message.Message,), {
  ...
  'UsersByPhoneEntry' : _reflection.GeneratedProtocolMessageType('UsersByPhoneEntry', (_message.Message,), {
    'DESCRIPTOR' : _RESPONSEGETCONTACTS_USERSBYPHONEENTRY,
    '__module__' : 'contacts_pb2'
    # @@protoc_insertion_point(class_scope:dialog.ResponseGetContacts.UsersByPhoneEntry)
    })
  ,
...
_sym_db.RegisterMessage(ResponseGetContacts.UsersByPhoneEntry)
...
_RESPONSEGETCONTACTS_USERSBYPHONEENTRY._options = None
