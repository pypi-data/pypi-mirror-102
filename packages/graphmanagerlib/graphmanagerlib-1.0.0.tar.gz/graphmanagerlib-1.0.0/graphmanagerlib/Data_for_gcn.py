...
def get_data(save_dataset_fd,documents):
    ...
    trainingProportion = (len(all_files) / 100) * 80
...
if __name__ == "__main__":
    #safe_fd = "C:\\AsianGCN\\data\\sroie\\processed"
    #get_data(source_fd="C:\\AsianGCN\\raw\\box", save_fd=safe_fd, export=False)
    getDataForUniquePrediction(source_fd="C:\\AsianGCN\\prediction\\raw\\box",
                               save_fd="C:\\AsianGCN\\prediction\\processed", export=False)
