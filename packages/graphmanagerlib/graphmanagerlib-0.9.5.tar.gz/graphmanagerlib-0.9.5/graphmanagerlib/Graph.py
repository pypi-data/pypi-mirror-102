...
class Grapher:
    ...
    def graph_formation(self):
        ...
        """
        df = pd.DataFrame([node.to_string() for node in self.nodes])
        """
        ...
        temp.columns = ['xmin', 'ymin', 'xmax', 'ymax','tag']
    ...
    def relative_distance(self,image_width, image_height):
        ...
        df.drop(['destination_x_hori', 'destination_y_hori', 'destination_y_vert', 'destination_x_vert', 'left', 'top', 'right', 'bottom'], axis=1,
                inplace=True)
