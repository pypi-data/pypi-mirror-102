...
class GraphManager:
    def __init__(self, documents, save_dataset_fd,nb_classes):
        self.save_dataset_path = save_dataset_fd
    ...
    def CreateTrainAndSaveGCN(self):
        ...
        CreateTrainAndSaveGCN(traindata, testdata, self.save_dataset_path, self.nb_classes)
