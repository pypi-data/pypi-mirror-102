...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'rabbitmq', '3.0.0-alpha.1618688465+614f2b41'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource rabbitmq 3.0.0-alpha.1618688465+614f2b41`
                """)
            else:
                raise
