...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', '3.0.0-alpha.1618782840+a46c7ccd'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul 3.0.0-alpha.1618782840+a46c7ccd`
                """)
            else:
                raise
