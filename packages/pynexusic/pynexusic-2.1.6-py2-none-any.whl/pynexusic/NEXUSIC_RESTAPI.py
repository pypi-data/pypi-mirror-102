        ...
        for event_idx, event in enumerate(events):
            ...
            if sameAsset and event_idx > 0:
                ...
                if 'asset_full_location' in event.keys():
                    if event['asset_full_location'] != events[event_idx - 1]['asset_full_location']:
            ...
            if sameWorkpack and event_idx > 0:
                ...
                if 'workpack_name' in event.keys():
                    if event['workpack_name'] != events[event_idx - 1]['workpack_name']:
                        x_filter = {"operator": "and",
            ...
            if sameEventType and event_idx > 0:
                ...
                if 'event_type' in event.keys():
                    if event['event_type'] != events[event_idx - 1]['event_type']:
