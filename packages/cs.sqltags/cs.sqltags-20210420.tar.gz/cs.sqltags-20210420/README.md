...
### Method `PolyValueMixin.pick_value(float_value, string_value, structured_value)`

Chose amongst the values available.

### Method `PolyValueMixin.set_all(self, float_value, string_value, structured_value)`

Set all the value fields.

### Property `PolyValueMixin.unixtime`

The UNIX timestamp is stored as a float.

### Property `PolyValueMixin.value`

Return the value for this `Tag`.

### Method `PolyValueMixin.value_test(other_value)`
...
## Class `SQLTagSet(cs.obj.SingletonMixin,cs.tagset.TagSet,builtins.dict,cs.dateutils.UNIXTimeMixin,cs.lex.FormatableMixin,cs.mappings.AttrableMappingMixin)`
