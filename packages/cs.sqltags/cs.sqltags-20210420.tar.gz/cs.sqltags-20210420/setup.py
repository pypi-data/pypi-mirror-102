...
setup(
 ...
 '`SQLtagsORM`.\n'    
 '\n'    
 '### Method `PolyValueMixin.pick_value(float_value, string_value, '    
 'structured_value)`\n'    
 '\n'    
 'Chose amongst the values available.\n'    
 '\n'    
 '### Method `PolyValueMixin.set_all(self, float_value, string_value, '    
 'structured_value)`\n'    
 '\n'    
 ...
 '\n'    
 '## Class '    
 '`SQLTagSet(cs.obj.SingletonMixin,cs.tagset.TagSet,builtins.dict,cs.dateutils.UNIXTimeMixin,cs.lex.FormatableMixin,cs.mappings.AttrableMappingMixin)`\n'    
 '\n'    
