...
class HTTP3Connection:
    ...
    def method (self, method, urls, data = None, headers = {}, allow_push = True, repeat = 1):
        issingle = False
    ...
    def get (self, urls, headers = {}, allow_push = True, repeat = 1):
        return self.method ('GET', urls, None, headers, allow_push, repeat)

    def post (self, urls, data, headers = {}, allow_push = True, repeat = 1):
        return self.method ('POST', urls, data, headers, allow_push, repeat)
