...
def get_device_logger(logger, device):
    serial_number, proxy_string = device_identifiers.get(device, "unknown")
...
class DeviceProxy(QtCore.QObject):
    ...
    def __init__(self, log_queue, serial_number, proxy_string, find_func,
                 *args, **kwargs):
        super().__init__()
...
class DeviceProxyManager:
    ...
    def new_proxy(self, serial_number, find_func, *args, **kwargs):
        ...
        proxy = DeviceProxy(self.logQueue, serial_number, proxy_string,
