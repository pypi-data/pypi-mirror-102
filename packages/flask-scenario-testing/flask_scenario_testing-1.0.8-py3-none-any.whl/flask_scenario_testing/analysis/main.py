...
def main():
    ...
    summary_sections = [
        ...
        PlotCpuUsageAgainstLatency('api.user_articles_recommended', service=ComputeCpuUsageAgainstLatency(
            results=results,
            averager=rounding_averager)
        ),
        PlotLatenciesOverTime(['api.user_articles_recommended'], averager),
