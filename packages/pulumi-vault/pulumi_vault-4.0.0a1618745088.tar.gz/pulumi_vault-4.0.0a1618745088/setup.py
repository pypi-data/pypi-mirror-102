...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', '4.0.0-alpha.1618745088+38fd2ff3'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault 4.0.0-alpha.1618745088+38fd2ff3`
                """)
            else:
                raise
