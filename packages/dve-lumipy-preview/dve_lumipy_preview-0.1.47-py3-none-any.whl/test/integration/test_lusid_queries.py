...
class TestLusidQueries(unittest.TestCase):
    ...
    def test_lusid_holdings_tutorial_queries(self):
        ...
        Holdings = self.atlas.lusid_portfolio_holding.get_class()
        holdings = Holdings(
    ...
    def test_lusid_joins_tutorial_queries(self):
        ...
        all_portfolios = self.atlas.lusid_portfolio_holding.get_class()(
        ...
        instruments = self.atlas.lusid_instrument.get_class()(
            effective_at=dt.datetime(2021, 4, 9),
            as_at=dt.datetime(2021, 4, 9)
        ).with_alias('ins')
        properties = self.atlas.lusid_property.get_class()(
            effective_at=dt.datetime(2021, 4, 9),
            as_at=dt.datetime(2021, 4, 9)
        ).with_alias('prp')
        quotes = self.atlas.lusid_instrument_quote.get_class(
    ...
    def test_lusid_unions(self):
        portfolios = self.atlas.lusid_portfolio.get_class()(
            effective_at=dt.datetime(2021, 4, 9),
            as_at=dt.datetime(2021, 4, 9)
        )
        ...
        holding = self.atlas.lusid_portfolio_holding.get_class()(
            effective_at=dt.datetime(2021, 4, 9),
            as_at=dt.datetime(2021, 4, 9)
        )
    ...
    def test_lusid_view(self):
        portfolio = self.atlas.lusid_portfolio.get_class()(
            effective_at=dt.datetime(2021, 4, 9),
            as_at=dt.datetime(2021, 4, 9)
        )
        ...
        make_view = qry.to_view(
            'Lusid/Portfolio/FbnExamplesPfCodes',
            f'test commit {hash(qry)}.'
        )
        ...
        view_def = new_atlas.lusid_portfolio_fbnexamplespfcodes.get_class()()
