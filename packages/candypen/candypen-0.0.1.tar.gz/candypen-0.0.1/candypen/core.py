...
# Command line tool
def gencandypen():
    """Generate your candypen based on templates.
    """
    parser = argparse.ArgumentParser("Generate your candypen based on templates")
    ...
    with open(spider_path, 'w', encoding='utf-8') as f:
        f.write(templ)
    logger.info("A candypen named %s is initialized." % args.name)
