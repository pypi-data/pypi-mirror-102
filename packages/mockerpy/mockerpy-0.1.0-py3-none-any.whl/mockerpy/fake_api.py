...
from .fake_node_response import read_fake_nodes
from .services import read_fake_services, read_fake_tasks

CURRENT_VERSION = "v{0}".format(constants.DEFAULT_DOCKER_API_VERSION)

FAKE_CONTAINER_ID = "3cc2351ab11b"
FAKE_IMAGE_ID = "sha256:0382cbe47ed68e59251211976f31ecf554b9a0d40b1340c6f302a671f3000dd1"
...
def get_fake_nodes(path):
    status_code = 200
    response = read_fake_nodes(path)
    return status_code, response


def get_fake_services(path):
    status_code = 200
    response = read_fake_services(path)
    return status_code, response


def get_fake_tasks(path):
    status_code = 200
    response = read_fake_tasks(path)
    return status_code, response
...
fake_responses = {
    ...
    "{1}/{0}/containers/3cc2351ab11b/start".format(CURRENT_VERSION, prefix): post_fake_start_container,
    "{1}/{0}/containers/3cc2351ab11b/resize".format(CURRENT_VERSION, prefix): post_fake_resize_container,
    "{1}/{0}/containers/3cc2351ab11b/json".format(CURRENT_VERSION, prefix): get_fake_inspect_container,
    "{1}/{0}/containers/3cc2351ab11b/rename".format(CURRENT_VERSION, prefix): post_fake_rename_container,
    ...
    "{1}/{0}/containers/3cc2351ab11b/update".format(CURRENT_VERSION, prefix): post_fake_update_container,
    ...
    "{1}/{0}/containers/3cc2351ab11b/stop".format(CURRENT_VERSION, prefix): post_fake_stop_container,
    "{1}/{0}/containers/3cc2351ab11b/kill".format(CURRENT_VERSION, prefix): post_fake_kill_container,
    "{1}/{0}/containers/3cc2351ab11b/pause".format(CURRENT_VERSION, prefix): post_fake_pause_container,
    "{1}/{0}/containers/3cc2351ab11b/unpause".format(CURRENT_VERSION, prefix): post_fake_unpause_container,
    "{1}/{0}/containers/3cc2351ab11b/restart".format(CURRENT_VERSION, prefix): post_fake_restart_container,
    ...
    ("{1}/{0}/swarm/join".format(CURRENT_VERSION, prefix), "POST"): post_fake_join_swarm,
    ("{1}/{0}/networks".format(CURRENT_VERSION, prefix), "GET"): get_fake_network_list,
    ("{1}/{0}/networks/create".format(CURRENT_VERSION, prefix), "POST"): post_fake_network,
