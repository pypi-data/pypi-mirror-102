...
[boto3.ElasticInference 1.17.54](https://boto3.amazonaws.com/v1/documentation/api/1.17.54/reference/services/elastic-inference.html#ElasticInference) service
compatible with
