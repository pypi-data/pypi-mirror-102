...
from NEMO.admin import ToolAdminForm, ToolAdmin, AreaAdmin, ConsumableAdmin
from NEMO.models import Tool, Consumable, Area
...
class CustomChargeAdmin(admin.ModelAdmin):
    ...
    search_fields = ("name", "customer", "project")
