...
import datetime, os, random, time, re, unicodedata, robot
...
class FacileToolkit2:
    ...
    def field_or_parents_should_contain_error(self, locator, timeout=None, error_class="wrong", error=None):
        self.wait_until_element_or_parents_contain_class(locator, error_class, timeout, error)

    @keyword
    def field_or_parents_should_be_verified(self, locator, timeout=None, verified_class="verified", error=None):
        self.wait_until_element_or_parents_contain_class(locator, verified_class, timeout, error)

    @keyword
    def field_should_contain_error(self, locator, timeout=None, error_class="wrong", error=None):
        self.wait_until_element_contains_class(locator, error_class, timeout, error)

    @keyword
    def field_should_be_verified(self, locator, timeout=None, verified_class="verified", error=None):
        self.wait_until_element_contains_class(locator, verified_class, timeout, error)
    ...
    @keyword
    def wait_until_element_contains_class(self, locator, clazz, timeout=None, error=None):
        self.set_selenium_library()
        self._wait_until(
    ...
    @keyword
    def wait_until_element_does_not_contain_class(self, locator, clazz, timeout=None, error=None):
        self.set_selenium_library()
        self._wait_until(
    ...
    @keyword
    def wait_until_element_or_parents_contain_class(self, locator, clazz, timeout=None, error=None):
    ...
    @keyword
    def wait_until_element_or_parents_do_not_contain_class(self, locator, clazz, timeout=None, error=None):
        elements = self.get_element_parents(locator)
        self._wait_until(
    ...
    def i_handle_gdpr(self, mandatory=False, timeout="5s"):
        ...
        try:
            self.sl.wait_until_element_is_visible('css:#onetrust-banner-sdk[style*="0px"],#onetrust-banner-sdk:not([style])', timeout)
        except:
            if mandatory:
                raise
        try:
