...
def _parse_response(*, response: httpx.Response) -> Optional[Union[List[ProjectRole], None]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[List[ProjectRole], None]]:
    return Response(
...
def sync_detailed(
    *,
    client: AuthenticatedClient,
) -> Response[Union[List[ProjectRole], None]]:
    kwargs = _get_kwargs(
        client=client,
    )
...
def sync(
    *,
    client: AuthenticatedClient,
) -> Optional[Union[List[ProjectRole], None]]:
