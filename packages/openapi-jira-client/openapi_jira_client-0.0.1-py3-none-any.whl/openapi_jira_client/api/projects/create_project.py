...
def _parse_response(*, response: httpx.Response) -> Optional[Union[None, ProjectIdentifiers]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[None, ProjectIdentifiers]]:
    return Response(
...
def sync_detailed(
    *,
    client: AuthenticatedClient,
    json_body: ProjectInputBean,
) -> Response[Union[None, ProjectIdentifiers]]:
    kwargs = _get_kwargs(
        client=client,
        json_body=json_body,
    )
...
def sync(
    *,
    client: AuthenticatedClient,
    json_body: ProjectInputBean,
) -> Optional[Union[None, ProjectIdentifiers]]:
