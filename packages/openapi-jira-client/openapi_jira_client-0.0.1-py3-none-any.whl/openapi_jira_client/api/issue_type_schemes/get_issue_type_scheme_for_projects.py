...
def _parse_response(*, response: httpx.Response) -> Optional[Union[None, PageBeanIssueTypeSchemeProjects]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[None, PageBeanIssueTypeSchemeProjects]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    max_results: Union[Unset, int] = 50,
    project_id: List[int],
) -> Response[Union[None, PageBeanIssueTypeSchemeProjects]]:
    kwargs = _get_kwargs(
        client=client,
        start_at=start_at,
...
def sync(
    *,
    ...
    max_results: Union[Unset, int] = 50,
    project_id: List[int],
) -> Optional[Union[None, PageBeanIssueTypeSchemeProjects]]:
