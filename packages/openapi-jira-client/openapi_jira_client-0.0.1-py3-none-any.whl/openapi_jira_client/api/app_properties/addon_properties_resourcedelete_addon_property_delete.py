...
def _parse_response(*, response: httpx.Response) -> Optional[Union[None, OperationMessage]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[None, OperationMessage]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    addon_key: str,
    property_key: str,
) -> Response[Union[None, OperationMessage]]:
    kwargs = _get_kwargs(
        client=client,
        addon_key=addon_key,
...
def sync(
    *,
    ...
    addon_key: str,
    property_key: str,
) -> Optional[Union[None, OperationMessage]]:
