...
T = TypeVar("T", bound="ComponentsschemasIssueUpdateDetailsUpdate")


@attr.s(auto_attribs=True)
class ComponentsschemasIssueUpdateDetailsUpdate:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        componentsschemas_issue_update_details_update = cls()
        ...
        componentsschemas_issue_update_details_update.additional_properties = additional_properties
        return componentsschemas_issue_update_details_update
