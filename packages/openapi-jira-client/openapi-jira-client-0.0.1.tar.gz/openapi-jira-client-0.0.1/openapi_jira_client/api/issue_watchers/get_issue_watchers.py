...
def _parse_response(*, response: httpx.Response) -> Optional[Union[None, Watchers]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[None, Watchers]]:
    return Response(
