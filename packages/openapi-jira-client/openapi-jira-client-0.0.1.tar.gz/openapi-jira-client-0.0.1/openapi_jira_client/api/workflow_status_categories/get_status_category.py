...
def _parse_response(*, response: httpx.Response) -> Optional[Union[None, StatusCategory]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[None, StatusCategory]]:
    return Response(
...
def sync_detailed(
    *,
    client: AuthenticatedClient,
    id_or_key: str,
) -> Response[Union[None, StatusCategory]]:
    kwargs = _get_kwargs(
        client=client,
        id_or_key=id_or_key,
    )
...
def sync(
    *,
    client: AuthenticatedClient,
    id_or_key: str,
) -> Optional[Union[None, StatusCategory]]:
