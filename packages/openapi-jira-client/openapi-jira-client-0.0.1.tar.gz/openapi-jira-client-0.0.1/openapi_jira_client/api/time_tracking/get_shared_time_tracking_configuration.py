...
def _parse_response(*, response: httpx.Response) -> Optional[Union[None, TimeTrackingConfiguration]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[None, TimeTrackingConfiguration]]:
    return Response(
...
def sync_detailed(
    *,
    client: AuthenticatedClient,
) -> Response[Union[None, TimeTrackingConfiguration]]:
    kwargs = _get_kwargs(
        client=client,
    )
...
def sync(
    *,
    client: AuthenticatedClient,
) -> Optional[Union[None, TimeTrackingConfiguration]]:
