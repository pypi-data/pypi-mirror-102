...
def _parse_response(*, response: httpx.Response) -> Optional[Union[None, PageBeanIssueTypeScreenScheme]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[None, PageBeanIssueTypeScreenScheme]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    max_results: Union[Unset, int] = 50,
    id_: Union[Unset, List[int]] = UNSET,
) -> Response[Union[None, PageBeanIssueTypeScreenScheme]]:
    kwargs = _get_kwargs(
        client=client,
        start_at=start_at,
...
def sync(
    *,
    ...
    max_results: Union[Unset, int] = 50,
    id_: Union[Unset, List[int]] = UNSET,
) -> Optional[Union[None, PageBeanIssueTypeScreenScheme]]:
