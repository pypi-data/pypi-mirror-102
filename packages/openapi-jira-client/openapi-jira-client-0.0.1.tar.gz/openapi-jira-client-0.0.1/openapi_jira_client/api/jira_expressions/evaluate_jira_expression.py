...
def _parse_response(*, response: httpx.Response) -> Optional[Union[ErrorCollection, JiraExpressionResult, None]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[ErrorCollection, JiraExpressionResult, None]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    json_body: JiraExpressionEvalRequestBean,
    expand: Union[Unset, str] = UNSET,
) -> Response[Union[ErrorCollection, JiraExpressionResult, None]]:
    kwargs = _get_kwargs(
        client=client,
        json_body=json_body,
        expand=expand,
...
def sync(
    *,
    ...
    json_body: JiraExpressionEvalRequestBean,
    expand: Union[Unset, str] = UNSET,
) -> Optional[Union[ErrorCollection, JiraExpressionResult, None]]:
