...
def _parse_response(*, response: httpx.Response) -> Optional[Union[ErrorCollection, PageBeanWebhook]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[ErrorCollection, PageBeanWebhook]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    start_at: Union[Unset, int] = 0,
    max_results: Union[Unset, int] = 100,
) -> Response[Union[ErrorCollection, PageBeanWebhook]]:
    kwargs = _get_kwargs(
        client=client,
        start_at=start_at,
...
def sync(
    *,
    ...
    start_at: Union[Unset, int] = 0,
    max_results: Union[Unset, int] = 100,
) -> Optional[Union[ErrorCollection, PageBeanWebhook]]:
