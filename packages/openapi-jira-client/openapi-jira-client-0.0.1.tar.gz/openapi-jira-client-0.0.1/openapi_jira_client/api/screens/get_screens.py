...
def _parse_response(*, response: httpx.Response) -> Optional[Union[None, PageBeanScreen]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[None, PageBeanScreen]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    max_results: Union[Unset, int] = 100,
    id_: Union[Unset, List[int]] = UNSET,
) -> Response[Union[None, PageBeanScreen]]:
    kwargs = _get_kwargs(
        client=client,
        start_at=start_at,
...
def sync(
    *,
    ...
    max_results: Union[Unset, int] = 100,
    id_: Union[Unset, List[int]] = UNSET,
) -> Optional[Union[None, PageBeanScreen]]:
