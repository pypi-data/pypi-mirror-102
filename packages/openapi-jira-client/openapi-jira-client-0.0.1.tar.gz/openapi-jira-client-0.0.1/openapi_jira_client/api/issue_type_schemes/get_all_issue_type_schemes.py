...
def _parse_response(*, response: httpx.Response) -> Optional[Union[None, PageBeanIssueTypeScheme]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[None, PageBeanIssueTypeScheme]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    max_results: Union[Unset, int] = 50,
    id_: Union[Unset, List[int]] = UNSET,
) -> Response[Union[None, PageBeanIssueTypeScheme]]:
    kwargs = _get_kwargs(
        client=client,
        start_at=start_at,
...
def sync(
    *,
    ...
    max_results: Union[Unset, int] = 50,
    id_: Union[Unset, List[int]] = UNSET,
) -> Optional[Union[None, PageBeanIssueTypeScheme]]:
