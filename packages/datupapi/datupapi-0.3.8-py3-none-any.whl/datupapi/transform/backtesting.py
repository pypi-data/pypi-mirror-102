...
class Backtesting(Config):
    ...
    def concat_backtest_datasets(self, q_backtest=None, backtests_names=None, datalake_path_=None):
        ...
        :param q_backtest: Name of backtesting dataset store in the datalake
        ...
        >>> df = concat_backtest_datasets(q_backtest='Qback', backtests_names=['alpha', 'beta'], datalake_path_='path/to/backtests/folder')
        >>> df =
                        var1    var2    var3
                idx0     1       2       3
        """
