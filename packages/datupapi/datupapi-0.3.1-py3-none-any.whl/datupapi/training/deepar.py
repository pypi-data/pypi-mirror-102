...
class DeepAR(Config):
    ...
    def create_dataset_import_deepar(self, import_job, dataset_arn, import_path, timestamp_format='yyyy-MM-dd'):
        """
    ...
    def create_predictor_deepar(self, predictor_name, dataset_group_arn, use_location=False):
        ...
        if self.dataset_frequency is 'D':
            context_length_min = 7
            context_length_max = 365
        elif self.dataset_frequency is 'W':
            context_length_min = 2
            context_length_max = 52
        elif self.dataset_frequency is 'M':
            context_length_min = 1
            context_length_max = 12
        elif self.dataset_frequency is 'Y':
            context_length_min = 1
