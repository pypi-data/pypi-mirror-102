...
setup(
    ...
    project_urls={
        'Documentation': 'https://scraper-helper.readthedocs.io/',
        'Changelog': 'https://scraper-helper.readthedocs.io/en/latest/changelog.html',
        'Issue Tracker': 'https://github.com/eupendra/scraper-helper/issues',
    },
    keywords=[
