...
class Basebot:
    ...
    def send_text(self,text,update,context,chat_id=None,*args):
        ...
        if chat_id is None:
            chat_id=update.message.chat_id
        context.bot.send_message(chat_id,text,args)
    def setup_jqe(self):
    ...
    # BETA Maybe dont work ↓
    def send_with_buttons(self,text,callback,buttons,update,context,chat_id=None):
