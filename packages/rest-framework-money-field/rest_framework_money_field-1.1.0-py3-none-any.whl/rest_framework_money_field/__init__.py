...
from moneyed import CurrencyDoesNotExist, Money, DEFAULT_CURRENCY, get_currency
...
class MoneyField(Field):
    def to_internal_value(self, data: Optional[MoneyRepresentation]) -> Optional[Money]:
        if data is None:
            return None
    ...
    def to_representation(self, value: Optional[Money]) -> MoneyRepresentation:
        ...
        # "XYZ" is a pseudocurrency code used by py-moneyed to indicate that
