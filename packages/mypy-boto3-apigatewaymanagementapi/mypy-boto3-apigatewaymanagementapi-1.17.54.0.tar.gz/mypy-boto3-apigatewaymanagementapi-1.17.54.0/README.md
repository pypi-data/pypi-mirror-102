...
[boto3.ApiGatewayManagementApi 1.17.54](https://boto3.amazonaws.com/v1/documentation/api/1.17.54/reference/services/apigatewaymanagementapi.html#ApiGatewayManagementApi) service
compatible with
