                        ...
                        if len(pool) == 0:
                            ...
                            for i in range(len(pool)):
                                ...
                                for j in range(0,400):
                                    ...
                                    tableft[j, i] = np.mean(mat[(x - background_up - background_size):(x - background_up), (y - background_up):(y + background_down)])
                                    tabcenter[j, i] = np.mean(mat[(x - background_up):(x + background_down), (y - background_up):(y + background_down)])
                                    tabright[j, i] = np.mean(mat[(x + background_down):(x + background_down + background_size), (y - background_up):(y + background_down)])
