...
[boto3.ServiceDiscovery 1.17.51](https://boto3.amazonaws.com/v1/documentation/api/1.17.51/reference/services/servicediscovery.html#ServiceDiscovery) service
compatible with
