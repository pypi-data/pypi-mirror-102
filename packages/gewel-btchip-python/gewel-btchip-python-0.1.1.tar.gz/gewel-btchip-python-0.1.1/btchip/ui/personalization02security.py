...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.TitleLabel.setText(_translate("Dialog", "Gewel Chip setup - security (2/3)", None))
        self.IntroLabel.setText(_translate("Dialog", "Please choose a security profile", None))
        self.HardenedButton.setText(_translate("Dialog", "Hardened", None))
        self.HardenedButton_2.setText(_translate("Dialog", "PIN only", None))
        self.IntroLabel_2.setText(_translate("Dialog", "You need to remove the dongle and insert it again to get a second factor validation of all operations. Recommended for expert users and to be fully protected against malwares.", None))
        self.IntroLabel_3.setText(_translate("Dialog", "You only need to enter a PIN once when inserting the dongle. Transactions are not protected against malwares", None))
        self.CancelButton.setText(_translate("Dialog", "Cancel", None))
        self.NextButton.setText(_translate("Dialog", "Next", None))
        self.IntroLabel_4.setText(_translate("Dialog", "Please choose a PIN associated to the Gewel Chip dongle. The PIN protects the dongle in case it is stolen, and can be up to 32 characters. The dongle is wiped  if a wrong PIN is entered 3 times in a row.", None))
        self.IntroLabel_5.setText(_translate("Dialog", "Enter the new PIN: ", None))
        self.IntroLabel_6.setText(_translate("Dialog", "Repeat the new PIN: ", None))
