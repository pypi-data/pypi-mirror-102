...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.IntroLabel.setText(_translate("Dialog", "If you do not trust this computer, perform the following steps on a trusted one or a different device. Anything supporting keyboard input will work (smartphone, TV box ...)", None))
        self.IntroLabel_2.setText(_translate("Dialog", "Open a text editor, set the focus on the text editor, then insert the dongle", None))
        self.IntroLabel_3.setText(_translate("Dialog", "After a very short time, the dongle will type the seed as hexadecimal (0..9 A..F) characters, starting with \"seed\" and ending with \"X\"", None))
        self.IntroLabel_4.setText(_translate("Dialog", "If you perform those steps on Windows, a new device driver will be loaded the first time and the seed will not be typed. This is normal.", None))
        self.IntroLabel_5.setText(_translate("Dialog", "If you perform those steps on Mac, you\'ll get a popup asking you to select a keyboard type the first time and the seed will not be typed. This is normal, just close the popup.", None))
        self.IntroLabel_6.setText(_translate("Dialog", "If you did not see the seed for any reason, keep the focus on the text editor, unplug and plug the dongle again twice.", None))
        self.IntroLabel_7.setText(_translate("Dialog", "Then press Next once you wrote the seed to a safe medium (i.e. paper) and unplugged the dongle", None))
