...
def test_ocr_base():
    dobotEdu = DobotEDU("yuyuyu", "yuyu78YU")
    # dobotEdu.set_portname("com2")
    image = ToBase64('C:/Users/Administrator/Pictures/idcards/3.jpg')
...
def test_set_converyor():
    ...
    portname = res[0]["portName"]
    do.magicbox.connect_dobot(portname)
    a = do.magicbox.set_converyor(portname, 0, True, 250)
    print(a)
...
def test_arm_speed():
    ...
    b = do.magician.get_arm_speed_ratio(portname, mg.JOG)
    print(a, b)
