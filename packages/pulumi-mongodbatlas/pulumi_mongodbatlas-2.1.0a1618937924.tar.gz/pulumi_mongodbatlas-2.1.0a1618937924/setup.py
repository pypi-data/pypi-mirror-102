...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'mongodbatlas', '2.1.0-alpha.1618937924+af7a4bad'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource mongodbatlas 2.1.0-alpha.1618937924+af7a4bad`
                """)
            else:
                raise
