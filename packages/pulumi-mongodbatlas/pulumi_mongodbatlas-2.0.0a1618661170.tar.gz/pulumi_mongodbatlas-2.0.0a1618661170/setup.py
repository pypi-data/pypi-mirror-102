...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'mongodbatlas', '2.0.0-alpha.1618661170+962492c7'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource mongodbatlas 2.0.0-alpha.1618661170+962492c7`
                """)
            else:
                raise
