...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'mongodbatlas', '2.0.0-alpha.1618518575+1db4f977'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource mongodbatlas 2.0.0-alpha.1618518575+1db4f977`
                """)
            else:
                raise
