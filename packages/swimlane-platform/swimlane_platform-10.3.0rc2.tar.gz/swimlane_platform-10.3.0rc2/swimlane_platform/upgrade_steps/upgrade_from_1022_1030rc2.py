...
class UpgradeFrom1022To1030rc2(UpgradeStep):
    FROM = semver.parse_version_info('10.2.2')  # type: semver.VersionInfo
    TO = semver.parse_version_info('10.3.0-rc2')  # type: semver.VersionInfo

    @info_function_start_finish('Upgrade From 10.2.2 To 10.3.0-rc2.')
    def process(self):
        # type: () -> None
